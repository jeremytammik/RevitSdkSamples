...
#Region "Helpers to get various specific element collections"
        ...
        ''' </summary>
        Shared Function GetAllModelElements(ByVal app As Revit.Application) As ElementSet
        ...
        ''' </summary>
        Shared Function GetAllWalls_2008(ByVal app As Revit.Application) As ElementSet
        ...
        As List(Of Revit.Element)
            ...
            Dim filterCategory As Revit.Filter = app.Create.Filter.NewCategoryFilter(cat)
        ...
        ''' </summary>
        Public Shared Function GetProjectInfoElem_2008(ByVal doc As Revit.Document) As Revit.Element
...
#Region "Group helpers"
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Shared Function GetAllGroups_2008(ByVal app As Revit.Application) As ElementSet
        ...
        ''' </summary>
        Shared Function GetAllRooms(ByVal app As Revit.Application) As List(Of Element)
            Dim elements As New List(Of Element)
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Shared Function GetAllGroups(ByVal app As Revit.Application) As List(Of Element)
            Dim elements As New List(Of Element)
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Shared Function GetAllGroupTypes_2008(ByVal app As Revit.Application) As ElementSet
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Shared Function GetAllGroupTypes(ByVal app As Revit.Application) As List(Of Element)
            Dim elements As New List(Of Element)
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Shared Function GetAllModelGroupTypes_2008(ByVal app As Revit.Application) As ElementSet
        ...
        Shared Function GetAllModelGroupTypes(ByVal app As Revit.Application) As List(Of Element)
            ...
            Dim elements As New List(Of Element)
            Dim filterType As Filter = app.Create.Filter.NewTypeFilter(GetType(GroupType))
            Dim filterParam = app.Create.Filter.NewParameterFilter(BuiltInParameter.SYMBOL_FAMILY_NAME_PARAM, CriteriaFilterType.Equal, LabConstants.gsGroupTypeModel)
