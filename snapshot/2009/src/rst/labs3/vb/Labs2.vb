...
Namespace RstLabs
    ...
    Public Class Lab2_1
        ...
        Implements IExternalCommand.Execute
            ...
            Dim columns As List(Of Revit.Element) = RacUtils.GetAllStandardFamilyInstancesForACategory(app, catStructuralColumns.Name)
            ...
            Dim frmEls As List(Of Revit.Element) = RacUtils.GetAllStandardFamilyInstancesForACategory(app, catStructuralFraming.Name)
    ...
    Public Class Lab2_2
        ...
        Implements IExternalCommand.Execute
            ...
            Dim struFnds As List(Of Revit.Element) = RacUtils.GetAllStandardFamilyInstancesForACategory(app, catStructuralFoundation.Name)
