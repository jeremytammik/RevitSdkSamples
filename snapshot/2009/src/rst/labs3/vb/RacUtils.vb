...
Namespace RstLabs
    ...
    Public Class RacUtils
        ...
        Shared Function GetAllWalls(ByVal revitApp As Revit.Application) As List(Of Revit.Element)
        ...
        Shared Function GetFamilySymbol(ByVal revitApp As Autodesk.Revit.Application, ByVal doc As Revit.Document, _
                       ByVal familyName As String, ByVal typeName As String) As FamilySymbol
        ...
        Shared Function GetAllGroups(ByVal revitApp As Revit.Application) As List(Of Revit.Element)
            'The following commented code is for Revit 2008 and previous version. It works in Revit 2009 and afterward version too. However this method has a low performance. . It works in Revit 2009 and afterward version too. However this method has a low performance.
            'There is a new feature named Element filter in Revit 2009 API, which can improve the performance.
        ...
        Shared Function GetAllGroupTypes(ByVal revitApp As Revit.Application) As List(Of Revit.Element)
            'The following commented code is for Revit 2008 and previous version. It works in Revit 2009 and afterward version too. However this method has a low performance. . It works in Revit 2009 and afterward version too. However this method has a low performance.
            'There is a new feature named Element filter in Revit 2009 API, which can improve the performance.
        ...
        Shared Function GetAllModelGroupTypes(ByVal revitApp As Revit.Application) As List(Of Revit.Element)
            'The following commented code is for Revit 2008 and previous version. It works in Revit 2009 and afterward version too. However this method has a low performance. . It works in Revit 2009 and afterward version too. However this method has a low performance.
            'There is a new feature named Element filter in Revit 2009 API, which can improve the performance.
            ...
            Dim listGroupTypes As List(Of Autodesk.Revit.Element) = New List(Of Revit.Element)
            Dim filterType As Revit.Filter = revitApp.Create.Filter.NewTypeFilter(GetType(GroupType))
            Dim filterParam As Revit.Filter
            filterParam = revitApp.Create.Filter.NewParameterFilter(BuiltInParameter.SYMBOL_FAMILY_NAME_PARAM, _
                                    CriteriaFilterType.Equal, "Model Group")
            Dim filterAnd As Revit.Filter
            filterAnd = revitApp.Create.Filter.NewLogicAndFilter(filterType, filterParam)
            Dim bRetVal As Boolean = revitApp.ActiveDocument.Elements(filterAnd, listGroupTypes)
