...
Public Class AcadCommands
    ...
    Public Sub Export()
        ...
        Try
            ...
            If _RSelems.Count > 0 Then
                ...
                dlg.Title = "RS Link - AutoCAD EXPORT to Revit"
                'dlg.FileName = dlg.InitialDirectory + "\RSLinkAcadToRevit.xml"
                dlg.FileName = "RSLinkAcadToRevit.xml"
    ...
    Public Sub Import()
        ...
        Try
            ...
            dlg.Filter = "RS Link xml files (*.xml)|*.xml"
            dlg.Title = "RS Link - AutoCAD IMPORT from Revit"
            If dlg.ShowDialog() = DialogResult.OK Then
