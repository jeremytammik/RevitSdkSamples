...
namespace RstLabs
{
  ...
  public class Lab2_1 : IExternalCommand
  {
    public CmdResult Execute( ExternalCommandData commandData, ref string message, ElementSet elements )
    {
      ...
      sMsg = "There are " + frmEls.Size.ToString() + " Structural FRAMING elements:" + "\r\n";
  ...
  public class Lab2_2 : IExternalCommand
  {
    ...
    public CmdResult Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
    {
      ...
      string sMsg = "There are " + struFnds.Size.ToString() + " Structural FOUNDATION (standard families only) elements :" + "\r\n";
  ...
  public class Lab2_3 : IExternalCommand
  {
    ...
    public CmdResult Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
    {
      ...
      sMsg = "There are " + contFootings.Size.ToString() + " Structural CONTINUOUS FOOTING (or Wall Foundations) elements:" + "\r\n";
