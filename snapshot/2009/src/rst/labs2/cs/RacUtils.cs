...
namespace RstLabs
{
  ...
  public class RacUtils
  {
    ...
    static ElementSet GetAllWalls(Application revitApp)
    {
    ...
    public static ElementSet GetAllStandardFamilyInstancesForACategory(Application revitApp, string catName)
    {
      //The following commented code is for Revit 2008 and previous version. It works in Revit 2009 too. However this method has a low performance.
      //There is a new feature named Element filter in Revit 2009 API, which can improve the performance.
      //ElementSet elems = revitApp.Create.NewElementSet();
    ...
    public static ElementSet GetAllGroups(Application revitApp)
    {
      //The following commented code is for Revit 2008 and previous version. It works in Revit 2009 too. However this method has a low performance.
      //There is a new feature named Element filter in Revit 2009 API, which can improve the performance.
      //ElementSet elems = revitApp.Create.NewElementSet();
    ...
    public static ElementSet GetAllGroupTypes(Application revitApp)
    {
      //The following commented code is for Revit 2008 and previous version. It works in Revit 2009 too. However this method has a low performance.
      //There is a new feature named Element filter in Revit 2009 API, which can improve the performance.
      //ElementSet elems = revitApp.Create.NewElementSet();
    ...
    public static ElementSet GetAllModelGroupTypes(Application revitApp)
    {
      ElementSet elems = revitApp.Create.NewElementSet();
      //The following commented code is for Revit 2008 and previous version. It works in Revit 2009 too. However this method has a low performance.
      //There is a new feature named Element filter in Revit 2009 API, which can improve the performance.
