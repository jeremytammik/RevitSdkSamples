...
namespace RstLabs
{
  ...
  {
    public CmdResult Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
    {
      ...
      foreach (LoadCase ldCase in ldCases)
      {
        ...
        sMsg += "  " + ldCase.Name + ", Id=" + ldCase.Id.Value.ToString() + ", Category=" + catName + "\r\n";
      ...
      return CmdResult.Succeeded; // added by joe
    }
  }
  ...
  public class Lab1_2 : IExternalCommand
  {
    ...
    public CmdResult Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
    {
      ...
      string sMsg = "There are " + loads.Size.ToString() + " Load objects in the model:" + "\r\n";
      string sHost;
      ...
      foreach (PointLoad ptLd in pointLoads)
      {
        ...
        sMsg = sMsg + "Id=" + ptLd.Id.Value.ToString()
              + ": F= " + F.X + "," + F.Y + ","              
              + " M= " + M.X + "," + M.Y + "," + M.Z
              + " Pt= " + pt.X + "," + pt.Y + "," + pt.Z
      ...
      foreach (LineLoad lnLd in lineLoads)
      {
        ...
        sMsg = sMsg + "Id=" + lnLd.Id.Value.ToString() 
              + ": F1= " + F1.X + "," + F1.Y + "," + F1.Z
              + ": F2= " + F2.X + "," + F2.Y + "," + F2.Z
              + " Start= " + ptStart.X + "," + ptStart.Y + "," + ptStart.Z 
  ...
  public class Lab1_4 : IExternalCommand
  {
    public CmdResult Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
    {
      ...
      string sMsg = "There are " + symbs.Size.ToString() + " Load Symbol objects in the model:" + "\r\n";
