...
Namespace RstLabs
    ...
    Public Class RstUtils
        ...
        Public Shared Function GetAllLoadNatures(ByVal revitApp As Revit.Application) As List(Of Revit.Element)
        ...
        Public Shared Function GetAllLoadCases(ByVal revitApp As Revit.Application) As List(Of Revit.Element)
        ...
        Public Shared Function GetAllLoadCombinations(ByVal revitApp As Revit.Application) As List(Of Revit.Element)
        ...
        Public Shared Function GetAllLoadUsages(ByVal revitApp As Revit.Application) As List(Of Revit.Element)
        ...
        Public Shared Function GetAllLoads(ByVal revitApp As Revit.Application) As List(Of Revit.Element)
        ...
        Public Shared Function GetAllLoadSymbols(ByVal revitApp As Revit.Application) As List(Of Revit.Element)
            ...
            Return listLoadTypeBases


        End Function

        Public Shared Function GetPointLoadSymbols(ByVal revitApp As Revit.Application) As List(Of Revit.Element)
