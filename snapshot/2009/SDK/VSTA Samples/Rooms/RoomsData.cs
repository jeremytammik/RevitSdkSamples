...
namespace Revit.SDK.Samples.Rooms.CS
{
    ...
    public class RoomsData
    {
        ...
        public RoomsData(ThisApplication application)
        {
            ...
            TypeFilter filterRoom = m_application.Create.Filter.NewTypeFilter(typeof(Room), false);
            List<Autodesk.Revit.Element> arrayRoom = new List<Autodesk.Revit.Element>();
            m_application.ActiveDocument.get_Elements(filterRoom, arrayRoom);

            foreach (Autodesk.Revit.Element ee in arrayRoom)
            {
            ...
            TypeFilter filterRoomTag = m_application.Create.Filter.NewTypeFilter(typeof(RoomTag), false);
            List<Autodesk.Revit.Element> arrayRoomTag = new List<Autodesk.Revit.Element>();
            m_application.ActiveDocument.get_Elements(filterRoomTag, arrayRoomTag);

            foreach (Autodesk.Revit.Element ee in arrayRoomTag)
            {
                // find the room tags
        ...
        private void ClassifyRooms()
        {
            ...
            {
                int idValue = tmpTag.Room.Id.Value;
        ...
        public void CreateTags()
        {
            foreach (Room tmpRoom in m_roomsWithoutTag)
            {
                ...
                //create room tag
                m_application.ActiveDocument.Create.NewRoomTag(tmpRoom, point, null);
            }
        }
        ...
        public void ExportFile(String fileName)
        {
            ...
            String projectTitle = m_application.ActiveDocument.Title;  //the name of the project
