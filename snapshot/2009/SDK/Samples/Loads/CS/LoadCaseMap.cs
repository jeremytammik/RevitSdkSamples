...
namespace Revit.SDK.Samples.Loads.CS
{
    ...
    public class LoadCasesMap
    {
        ...
        ElementId m_loadCasesNatureId; //Store the Id of the load case's nature
        ElementId m_loadCasesCategoryId;//Store the Id of the load case's category
        ...
        /// CategoryId property.
        /// </summary>
        public ElementId LoadCasesCategoryId
        {
            get
            {
        ...
        /// <summary>
        /// Find the Nature and Catefory of the Load Case.
        /// </summary>
        /// <returns>A value that signifies whether success(true) or not.</returns>
        private bool FindProperty()
        {
            Parameter pNumber = m_loadCase.get_Parameter(Autodesk.Revit.Parameters.BuiltInParameter.LOAD_CASE_NUMBER);
            if (null == pNumber)
            {
                m_loadCasesNumber = "";
            }
            ...
            Parameter pCategoryid = m_loadCase.get_Parameter(Autodesk.Revit.Parameters.BuiltInParameter.LOAD_CASE_CATEGORY);
            m_loadCasesCategoryId = pCategoryid.AsElementId();

            Parameter pNatureId = m_loadCase.get_Parameter(Autodesk.Revit.Parameters.BuiltInParameter.LOAD_CASE_NATURE);
        ...
        {
            Parameter pName = m_loadCase.get_Parameter(Autodesk.Revit.Parameters.BuiltInParameter.LOAD_CASE_NAME);
        ...
        {
            Parameter pNature = m_loadCase.get_Parameter(Autodesk.Revit.Parameters.BuiltInParameter.LOAD_CASE_NATURE);
            pNature.Set(ref m_loadCasesNatureId);
            return true;
        }
        ...
        {
            Parameter pCategory = m_loadCase.get_Parameter(Autodesk.Revit.Parameters.BuiltInParameter.LOAD_CASE_CATEGORY);
            pCategory.Set(ref m_loadCasesCategoryId);
            return true;
        }
    }
