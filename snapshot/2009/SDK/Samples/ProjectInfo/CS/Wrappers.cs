...
namespace Revit.SDK.Samples.ProjectInfo.CS
{
    ...
    public class gbXMLParamElemWrapper : IWrapper
    {
        ...
        /// <summary>
        /// Gets or sets Shading Surfaces
        /// </summary>
        [DisplayName("Shading Surfaces"), RevitVersion(RevitStartInfo.RME, RevitStartInfo.RAC)]
        public Boolean ShadingSurfaces
        {
            get
            {
                return m_gbXMLParamElem.ShadingSurfaces;
            }
            set
            {
                m_gbXMLParamElem.ShadingSurfaces = value;
            }
        }
