...
namespace Revit.SDK.Samples.ParameterUtils.CS
{
    ...
    public class Command : IExternalCommand
    {
            ...
            ElementSet elements)
        {
            ...
            SelElementSet seletion = app.ActiveDocument.Selection.Elements;
            ...
            if (seletion.Size == 1)
            {
                ...
                foreach (Parameter param in parameters)
                {
                    ...
                    // double, int, string, ElementId and None. 
                    ...
                    switch (param.StorageType)
                    {
                        ...
                        case Autodesk.Revit.Parameters.StorageType.ElementId:
                            ...
                            // using ActiveDocument.get_Element(the element id) to 
                            // retrieve the element from the active document
                            ElementId elemId;
                            elemId.Value = param.AsElementId().Value;
                            Element elem = app.ActiveDocument.get_Element(ref elemId);
