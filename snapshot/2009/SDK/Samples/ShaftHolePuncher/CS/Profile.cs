...
namespace Revit.SDK.Samples.ShaftHolePuncher.CS
{
    ...
    public abstract class Profile
    {
        ...
        protected List<XYZArray> m_points; 
        ...
        public virtual List<XYZArray> GetNeedPoints(List<List<Edge>> faces)
        {
            return null;
        }
        ...
        public virtual void Draw2D(Graphics graphics, Pen pen, Matrix4 matrix4)
        {
            ...
            for (int i = 0; i < m_points.Count; i++)
            {
                ...
                {
                    XYZ point1 = points.get_Item(j);
                    XYZ point2 = points.get_Item(j + 1);
        ...
        public virtual List<List<Edge>> GetFaces(Autodesk.Revit.Element elem)
        {
