...
#End Region
    ...
    ''' <remarks></remarks>
    Public Function Initialize(ByVal Application As Autodesk.Revit.Application) As Boolean
    ...
    Public ReadOnly Property Document() As Autodesk.Revit.Document
        Get
            Document = m_application.ActiveDocument
        End Get
    End Property

    Public ReadOnly Property Application() As Autodesk.Revit.Application
        Get
