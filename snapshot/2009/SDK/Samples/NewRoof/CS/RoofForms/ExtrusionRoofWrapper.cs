...
namespace Revit.SDK.Samples.NewRoof.RoofForms.CS
{
    ...
    public class ExtrusionRoofWrapper
    {
        ...
        /// <summary>
        /// The extrusion start point of the the extrusion roof.
        /// </summary>
        [Category("Constrains")]
        ...
        /// <summary>
        /// The extrusion end point of the the extrusion roof.
        /// </summary>
        [Category("Constrains")]
        ...
        public Level ReferenceLevel
        {
            get
            {
                ...
                return LevelConverter.GetLevelByID(para.AsElementId().Value);
            }
            set
            {
