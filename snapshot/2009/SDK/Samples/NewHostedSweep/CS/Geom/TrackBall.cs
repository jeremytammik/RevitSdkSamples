...
namespace Revit.SDK.Samples.NewHostedSweep.CS
{
    ...
    public class TrackBall
    {
        ...
        private void Track(Point currentPosition)
        {
            ...
            XYZ axis = m_previousPosition3D.Cross(currentPosition3D);
            if (axis.Length == 0) return;

            double angle = m_previousPosition3D.Angle(currentPosition3D);
            m_rotation = Transform.get_Rotation(XYZ.Zero, axis, -angle);
