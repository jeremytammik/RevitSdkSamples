...
namespace Revit.SDK.Samples.MaterialProperties.CS
{
    ...
    public class MaterialPropertiesForm : System.Windows.Forms.Form
    {
        ...
        private void typeComboBox_SelectedIndexChanged(object sender, System.EventArgs e)
        {
            ...
            else if ((MaterialType)typeComboBox.SelectedIndex == MaterialType.Generic)
            {
        ...
        {
            MessageBox.Show("This will change unit weight all instances of the elements that use this material.");
        ...
        private void LoadCurrentMaterial()
        {
            ...
            if (null == m_dataBuffer.CurrentMaterial || m_dataBuffer.CurrentType == MaterialType.Generic)
            {
                return;
            }
            Autodesk.Revit.Elements.Material tmp = m_dataBuffer.CurrentMaterial as Autodesk.Revit.Elements.Material;
            if (null == tmp)
                return;
