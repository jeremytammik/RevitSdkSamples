...
namespace Revit.SDK.Samples.AddSpaceAndZone.CS
{
    ...
    class ZoneManager
    {
        ...
        {
            Zone zone = m_commandData.Application.ActiveDocument.Create.NewZone(level, phase);
            if (zone != null)
            {
                this.m_zoneDictionary[level.Id.Value].Add(zone);
            }
        }
        ...
        public List<Zone> GetZones(Level level)
        {
            ...
            return m_zoneDictionary[level.Id.Value];
        }
