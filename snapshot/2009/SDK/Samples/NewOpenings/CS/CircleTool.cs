...
namespace Revit.SDK.Samples.NewOpenings.CS
{
    ...
    class CircleTool:ITool
    {
        ...
        /// <summary>
        /// graw circles contained in the tool
        /// </summary>
        ...
        /// </summary>
        /// <param name="graphic">gdiplus object,used to draw geometry</param>
        ...
        /// </summary>
        /// <param name="grathic">Graphics object,used  to draw geometry</param>
        ...
        private void DrawCircle(Graphics grathic,Pen pen, Point pCenter, Point pBound)
        {
            ...
            grathic.DrawEllipse(pen, uperLeft.X, uperLeft.Y, 2 * radius, 2 * radius);
        }        
    }
}
