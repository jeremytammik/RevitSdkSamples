...
namespace Revit.SDK.Samples.CurtainWallGrid.CS
{
    ...
    public class WallGeometry
    {
        ...
        Autodesk.Revit.Elements.ViewPlan m_selectedView;
        ...
        //store the start point of baseline (in XYZ format)
        XYZ m_startXYZ;
     
        // store the end point of baseline (in PointD format)
        PointD m_endPointD;
      
        //store the end point of baseline (in XYZ format)
        XYZ m_endXYZ;
        #endregion
        ...
        /// the selected ViewPlan used for curtain wall creation
        /// </summary>
        public Autodesk.Revit.Elements.ViewPlan SelectedView
        {
            get
            {
        ...
        public Wall CreateCurtainWall()
        {
            ...
            Autodesk.Revit.Creation.Document createDoc = m_myDocument.ActiveDocument.Create;
            Autodesk.Revit.Creation.Application createApp = m_myDocument.CommandData.Application.Create;
            //baseline
            Point point0 = m_drawing.WallLine2D.StartPoint;
            Point point1 = m_drawing.WallLine2D.EndPoint;
            ...
            m_myDocument.ActiveDocument.BeginTransaction();
            Wall wall = createDoc.NewWall(baseline, m_selectedWallType, 
                m_selectedView.GenLevel, 20, 0, false, false);
            m_myDocument.ActiveDocument.ShowElements(wall);
            m_myDocument.ActiveDocument.EndTransaction();
            return wall;
        }
        #endregion
    }// end of class
