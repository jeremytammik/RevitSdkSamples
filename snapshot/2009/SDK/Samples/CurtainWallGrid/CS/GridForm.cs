...
namespace Revit.SDK.Samples.CurtainWallGrid.CS
{
    ...
    public partial class GridForm : Form
    {
        ...
        {
            m_myDocument = myDoc;
            if (null == m_myDocument.ActiveDocument)
            {
                this.Close();
            }
        ...
        private void InitializeCustomComponent()
        {
            ...
            foreach (Autodesk.Revit.Elements.View view in m_myDocument.Views)
            {
            ...
            // initialize the wall drawing's canvas information
            {
                ...
                Point rectLocation = curtainWallPictureBox.ClientRectangle.Location;
                ...
                Point originPoint = new Point(midX, midY);
