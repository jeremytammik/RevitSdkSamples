...
namespace Revit.SDK.Samples.NewRebar.CS
{
    ...
    public abstract class RebarShapeParameter
    {
        ...
        protected ExternalDefinition GetOrCreateDef(DefinitionGroup group)
        {
            ...
            if (Bdef == null)
            {
               ExternalDefinitonCreationOptions externalDefinitonCreationOptions = new ExternalDefinitonCreationOptions(m_name, ParameterType.ReinforcementLength);
               Bdef = group.
                   Definitions.Create(externalDefinitonCreationOptions) as ExternalDefinition;
            }
