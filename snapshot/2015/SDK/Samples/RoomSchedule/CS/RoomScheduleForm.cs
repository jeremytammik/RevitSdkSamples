    ...
    public partial class RoomScheduleForm : System.Windows.Forms.Form
    {
        ...
        private bool CreateMyRoomSharedParameter()
        {
            ...
            try
            {
                ...
                ExternalDefinitonCreationOptions externalDefinitonCreationOptions = new ExternalDefinitonCreationOptions(RoomsData.SharedParam, ParameterType.Text);
                Definition roomSharedParamDef = apiGroup.Definitions.Create(externalDefinitonCreationOptions);
