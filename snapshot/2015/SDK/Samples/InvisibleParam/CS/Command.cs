    ...
    public class Command : IExternalCommand
    {
            ...
            ExternalCommandData commandData, ref string message, Autodesk.Revit.DB.ElementSet elements)
        {
            ...
            try
            {
                ...
                ExternalDefinitonCreationOptions externalDefinitonCreationOptions1 = new ExternalDefinitonCreationOptions("VisibleParam", ParameterType.Text);
                Definition visibleParamDef = apiGroup.Definitions.Create
                    (externalDefinitonCreationOptions1);
                                        ;
                ...
                ExternalDefinitonCreationOptions externalDefinitonCreationOptions2 = new ExternalDefinitonCreationOptions("InvisibleParam", ParameterType.Text);
                Definition invisibleParamDef = apiGroup.Definitions.Create
                    (externalDefinitonCreationOptions2);
