...
Public Class ApplyParameter
   ...
   Private Function OpenDefinition(ByVal fireGroup As Autodesk.Revit.DB.DefinitionGroup) As Autodesk.Revit.DB.Definition
      ...
      Dim externalDefinitonCreationOptions As Autodesk.Revit.DB.ExternalDefinitonCreationOptions
      externalDefinitonCreationOptions = New DB.ExternalDefinitonCreationOptions(mParameterName, Autodesk.Revit.DB.ParameterType.Integer)
      If definition Is Nothing Then
