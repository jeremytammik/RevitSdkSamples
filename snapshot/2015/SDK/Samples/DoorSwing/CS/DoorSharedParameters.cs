   ...
   public static class DoorSharedParameters
   {
      ...
      public static void AddSharedParameters(UIApplication app)
      {
         ...
         if (!AlreadyAddedSharedParameter(app.ActiveUIDocument.Document, "BasalOpening", BuiltInCategory.OST_Doors))
         {
            ...
            {
               ExternalDefinitonCreationOptions externalDefinitonCreationOptions1 = new ExternalDefinitonCreationOptions("BasalOpening", ParameterType.Text);
               basalOpening = defGroup.Definitions.Create(externalDefinitonCreationOptions1);
            }
         ...
         if (!AlreadyAddedSharedParameter(app.ActiveUIDocument.Document, "InstanceOpening", BuiltInCategory.OST_Doors))
         {
            ...
            {
               ExternalDefinitonCreationOptions externalDefinitonCreationOptions2 = new ExternalDefinitonCreationOptions("InstanceOpening", ParameterType.Text);
               instanceOpening = defGroup.Definitions.Create(externalDefinitonCreationOptions2);
            }
         ...
         if (!AlreadyAddedSharedParameter(app.ActiveUIDocument.Document, "Internal Door", BuiltInCategory.OST_Doors))
         {
            ...
            {
               ExternalDefinitonCreationOptions externalDefinitonCreationOptions3 = new ExternalDefinitonCreationOptions("Internal Door", ParameterType.YesNo);
               internalDoorFlag = defGroup.Definitions.Create(externalDefinitonCreationOptions3);
            }
