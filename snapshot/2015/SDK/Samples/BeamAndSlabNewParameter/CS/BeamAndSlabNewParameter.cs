...
namespace Revit.SDK.Samples.BeamAndSlabNewParameter.CS
{
    ...
    public class Command : IExternalCommand
    {
        ...
        public bool SetNewParameterToBeamsAndSlabs ()
        {
            ...
            if (null == information)
            {
               ExternalDefinitonCreationOptions externalDefinitonCreationOptions = new ExternalDefinitonCreationOptions("Unique ID", Autodesk.Revit.DB.ParameterType.Text);
               informationCollection.Definitions.Create(externalDefinitonCreationOptions);
