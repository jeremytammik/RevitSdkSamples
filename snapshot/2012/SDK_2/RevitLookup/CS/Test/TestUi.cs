...
namespace RevitLookup.Test {
    ...
    class TestUi : RevitLookupTestFuncs {
        ...
        public void SelectElement()
        {
            ...
            try
            {
                Autodesk.Revit.DB.Element elem = m_revitApp.ActiveUIDocument.Document.get_Element(selSet.PickObject(Autodesk.Revit.UI.Selection.ObjectType.Element).ElementId);
