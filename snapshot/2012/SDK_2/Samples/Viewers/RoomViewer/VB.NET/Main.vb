...
Public Class RoomViewer
    ...
    Private Sub DrawRoomOutline(ByVal room As Autodesk.Revit.DB.Architecture.Room)
        ...
        Dim boundaries As Autodesk.Revit.DB.Architecture.BoundarySegmentArrayArray
        ...
        If boundaries Is Nothing Then
            ...
            Return
        End If
        Dim boundary As Autodesk.Revit.DB.Architecture.BoundarySegmentArray

        For Each boundary In boundaries
            Dim segment As Autodesk.Revit.DB.Architecture.BoundarySegment
