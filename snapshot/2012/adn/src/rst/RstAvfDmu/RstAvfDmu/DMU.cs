...
namespace RstAvfDmu
{
  ...
  public class RebarUpdater : IUpdater
  {
      ...
      try
      {
          ...
          data.GetModifiedElementIds() )
        {
          ...
          foreach( Rebar rebar in rebars )
          {
            ...
            // rebar line geometry
            //Line rebarLine = rebar.Curves.get_Item( 0 ) as Line; // 2011
            Line rebarLine = rebar.GetCenterlineCurves( false )[0] as Line; // 2012
    ...
    {
      XYZ v = line.get_EndPoint( 1 ) - line.get_EndPoint( 0 );
      return v.GetLength();
    }
