...
Public Class ModelCreation
  ...
  Function CreateWalls() As List(Of Wall)
    ...
    For i As Integer = 0 To 3
      ...
      Dim baseCurve As Line = _app.Create.NewLineBound(pts(i), pts(i + 1))
      ' Create a wall using the one of overloaded methods. 
      Dim aWall As Wall = _doc.Create.NewWall(baseCurve, level1, isStructural)
  ...
  Sub AddDoor(ByVal hostWall As Wall)
    ...
    Dim level1 As Level = _doc.Element(idLevel1)
  ...
  Sub AddRoof(ByVal walls As List(Of Wall))
    ...
    For i As Integer = 0 To 3
      ...
      Dim line As Line = _app.Create.NewLineBound(pt1, pt2)
    ...
    Dim level2 As Level = _doc.Element(idLevel2)
