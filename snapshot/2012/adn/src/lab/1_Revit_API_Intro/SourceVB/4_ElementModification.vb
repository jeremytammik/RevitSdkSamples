...
Public Class ElementModification
  ...
  Public Function Execute( _
    ...
    Dim ref As Reference = uiDoc.Selection.PickObject(ObjectType.Element, "Pick an element")
  ...
  Sub ModifyElementPropertiesWall(ByVal e As Element)
    ...
    Dim newWallLine As Line = _app.Create.NewLineBound(newPt1, newPt2)
  ...
  Sub ModifyElementByDocumentMethods(ByVal e As Element)
    ...
    Dim pt1 = XYZ.Zero
    Dim pt2 = XYZ.BasisZ
    Dim axis As Line = _app.Create.NewLineBound(pt1, pt2)
