...
Public Class DBElement
  ...
  Public Function Execute( _
    ...
    Dim elemType As ElementType = _doc.Element(elemTypeId)
  ...
  Public Sub ShowLocation(ByVal e As Element)
    ...
    ElseIf TypeOf loc Is LocationCurve Then
      ...
      s += "EndPoint(0)/Start Point = " + PointToString(crv.EndPoint(0)) + vbCr
      s += "EndPoint(1)/End point = " + PointToString(crv.EndPoint(1)) + vbCr
