...
namespace IntroCs
{
  ...
  public class ElementModification : IExternalCommand
  {
      ...
      ElementSet elements)
    {
      ...
      Reference r = uiDoc.Selection.PickObject(ObjectType.Element, "Pick a door, please");
    ...
    public void ModifyElementPropertiesWall(Element e)
    {
      ...
      Line newWallLine = _app.Create.NewLineBound(newPt1, newPt2);
    ...
    public void ModifyElementByTransformUtilsMethods(Element e)
    {
      ...
      XYZ pt1 = XYZ.Zero;
      XYZ pt2 = XYZ.BasisZ;
      Line axis = _app.Create.NewLineBound(pt1, pt2);
