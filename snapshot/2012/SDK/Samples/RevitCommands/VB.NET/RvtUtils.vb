...
Public Class RvtUtils
    ...
    Public Shared Sub ListTypeParameters(ByVal elem As Autodesk.Revit.DB.Element)
        ...
        Dim type As Autodesk.Revit.DB.ElementType = elem.Document.Element(typeId)
    ...
    ByVal param As Autodesk.Revit.DB.Parameter) As String
        ...
        Select Case type
            ...
            Case StorageType.ElementId
                ...
                Dim paraElem As Autodesk.Revit.DB.Element = rvtDoc.Element(param.AsElementId)
    ...
    Public Shared Sub ListLocation(ByVal elem As Autodesk.Revit.DB.Element)
        ...
        If TypeOf loc Is LocationCurve Then
            ...
            Dim startPt As Autodesk.Revit.DB.XYZ = crv.Curve.EndPoint(0)
            Dim endPt As Autodesk.Revit.DB.XYZ = crv.Curve.EndPoint(1)
