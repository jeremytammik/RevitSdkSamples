...
namespace Revit.SDK.Samples.AutoRoute.CS
{
    ...
    public class Command : IExternalCommand
    {
            ...
            ElementSet elements)
        {
            ...
            try
            {
                ...
                {
                    Element element = m_document.get_Element(ids[i]);
                    if (null == element)
                    {
                ...
                dtRectangle = m_document.get_Element(ductTypeId) as DuctType;
        ...
        private MechanicalSystem CreateMechanicalSystem(
          ConnectorInfo baseConnector, 
          ...
          DuctSystemType systemType)
        {
            ...
            MechanicalSystem mechanicalSystem = m_document.Create.NewMechanicalSystem(
              baseConnector == null ? null : baseConnector.Connector, 
              cset, 
              systemType );
        ...
        public class ConnectorInfo
        {
            ...
            public static ConnectorSet GetConnectors(int ownerId)
            {
                ...
                Element element = m_document.get_Element(elementId);
    ...
    public class LogUtility
    {
        ...
        public static T GetElement<T>(Document document, int eid) where T : Autodesk.Revit.DB.Element
        {
            ...
            return document.get_Element(elementId) as T;
        }
