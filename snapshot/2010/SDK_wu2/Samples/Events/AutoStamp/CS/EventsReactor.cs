    ...
    public sealed class EventsReactor
    {
        ...
        public void AppViewPrinting(object sender, Autodesk.Revit.Events.ViewPrintingEventArgs e)
        {
            ...
            try
            {
                ...
                //
                // This compile symbol is used for regression test
#if(JOURNAL_ENABLED)
                ...
                if(null != newTextNote)
                {
                    ...
                    m_newTextNoteId.Value = newTextNote.Id.Value;
                }
                else
                {
                    faileOccur = true;
        ...
        public void AppViewPrinted(object sender, Autodesk.Revit.Events.ViewPrintedEventArgs e)
        {
            ...
            if(EventStatus.Cancelled != e.Status)
            {
                e.Document.Delete(ref m_newTextNoteId);
