...
namespace Revit.SDK.Samples.PrintLog.CS
{
    ...
    public sealed class EventsReactor
    {
        ...
        /// <param name="e"></param>
        public void AppDocumentPrinting(object sender, Autodesk.Revit.Events.DocumentPrintingEventArgs e)
        {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        public void AppViewPrinting(object sender, Autodesk.Revit.Events.ViewPrintingEventArgs e)
        {
            // header information
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        public void AppViewPrinted(object sender, Autodesk.Revit.Events.ViewPrintedEventArgs e)
        {
            // header information
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        public void AppDocumentPrinted(object sender, Autodesk.Revit.Events.DocumentPrintedEventArgs e)
        {
            // header information
        ...
        private static void DumpEventArguments(RevitEventArgs eventArgs)
        {
            // Dump parameters now:
            ...
            else if (eventArgs.GetType().Equals(typeof(DocumentPrintedEventArgs)))
            {
                ...
                //
                // PrintedViews
                if (null == args.FailedViews || 0 == args.PrintedViews.Size)
                {
                ...
                else
                {
                    ...
                    DumpViewsInfo(args.PrintedViews, "      ");
                }
                //
                // FailedViews
                if (null == args.FailedViews || 0 == args.FailedViews.Size)
                {
                ...
                else
                {
                    ...
                    DumpViewsInfo(args.FailedViews, "      ");
                }
            }
        ...
        /// </summary>
        /// <param name="views">Views to be dumped to log files.</param>
        /// <param name="prefix">Prefix mark for each line dumped to log files.</param>
        private static void DumpViewsInfo(ViewSet views, String prefix)
        {
            int index = 0;
            ViewSetIterator vsi = views.ForwardIterator();
            vsi.Reset();
            while(vsi.MoveNext())
            {
                View curView = vsi.Current as View;
                if(null != curView)
                {
