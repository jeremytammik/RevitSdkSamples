...
namespace Revit.SDK.Samples.NewRoof.CS
{
    ...
    {
        // internal buffer
        private static Autodesk.Revit.Elements.View m_activeView;

        /// <summary>
        /// singleton in the external application
        /// </summary>
        public static Autodesk.Revit.Elements.View ActiveView
        {
            get
            {
                return m_activeView;
                                               ...
                                               ElementSet elements)
        {
            try
            {
                m_activeView = commandData.Application.ActiveDocument.ActiveView;
