...
namespace Revit.SDK.Samples.NewHostedSweep.CS
{
    ...
    public class GutterCreator : HostedSweepCreator
    {
        ...
        public GutterCreator(Autodesk.Revit.Document rvtDoc)
            : base(rvtDoc)
        {
        }
        ...
        /// </summary>
        private Dictionary<Autodesk.Revit.Element, List<Edge>> m_roofGutterEdges;

        /// <summary>
        /// Filter all the edges from the element which gutter can be created on.
        /// </summary>
        /// <param name="elem"></param>
        private void FilterEdgesForGutter(Autodesk.Revit.Element elem)
        {
        ...
        public override Dictionary<Autodesk.Revit.Element, List<Edge>> SupportEdges
        {
            get
            {
                ...
                {
                    m_roofGutterEdges = new Dictionary<Autodesk.Revit.Element, List<Edge>>();
