...
namespace Revit.SDK.Samples.CurtainSystem.CS.Data
{
    ...
    public class Document
    {
        ...
        Autodesk.Revit.Document m_activeDocument;
        /// <summary>
        /// the active document of Revit
        /// </summary>
        public Autodesk.Revit.Document ActiveDocument
        {
            get
            {
        ...
        /// object which contains reference of Revit Applicatio
        /// </param>
        public Document(ExternalCommandData commandData)
        {
        ...
        {
            CurtainSystemTypeSet types = m_activeDocument.CurtainSystemTypes;
