...
namespace Revit.SDK.Samples.InplaceFamilyAnalyticalModel3D.CS
{
    ...
    public class Command : IExternalCommand
    {
        ...
        public IExternalCommand.Result Execute(Autodesk.Revit.ExternalCommandData revit,
                                               ...
                                               ElementSet elements)
        {
            IExternalCommand.Result returnCode = IExternalCommand.Result.Cancelled;

            // Create the log file.
            string actullyLogFile = Path.Combine(Path.GetDirectoryName(this.GetType().Assembly.Location), "InplaceFamilyAnalyticalModel3D.log");
            ...
            TraceListener textListener = new TextWriterTraceListener(actullyLogFile);
