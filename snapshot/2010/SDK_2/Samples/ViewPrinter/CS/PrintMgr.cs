...
namespace Revit.SDK.Samples.ViewPrinter.CS
{
    ...
    public class PrintMgr
    {
        ...
        public PrintMgr(ExternalCommandData commandData)
        {
            ...
            m_printMgr = commandData.Application.ActiveDocument.PrintManager;
        }
        ...
        public string PrintSetupName
        {
            get
            {
                return m_printMgr.PrintSetup.CurrentPrintSetting.Name;
            }
        }
        ...
        public string ChangePrintToFileName()
        {
            using (SaveFileDialog saveDlg = new SaveFileDialog())
            {
                ...
                {
                    case Autodesk.Revit.Enums.VirtualPrinterType.AdobePDF:
                        saveDlg.Filter = "pdf files (*.pdf)|*.pdf";
                        postfix = ".pdf";
                        break;
                    case Autodesk.Revit.Enums.VirtualPrinterType.DWFWriter:
                        saveDlg.Filter = "dwf files (*.dwf)|*.dwf";
                        postfix = ".dwf";
                        break;
                    case Autodesk.Revit.Enums.VirtualPrinterType.None:
                ...
                string title = m_commandData.Application.ActiveDocument.Title;
        ...
        public Autodesk.Revit.Enums.PrintRange PrintRange
        {
            get
            {
        ...
        public string SelectedViewSheetSetName
        {
            get
            {
                return m_printMgr.ViewSheetSetting.CurrentViewSheetSet.Name;
            }
        }
            ...
            get
            {
                ...
                switch (m_printMgr.IsVirtual)
                {
                    ...
                    case Autodesk.Revit.Enums.VirtualPrinterType.DWFWriter:
                        postfix = ".dwf";
                        break;
                    case Autodesk.Revit.Enums.VirtualPrinterType.XPSWriter:
                        postfix = ".xps";
                        break;
                    case Autodesk.Revit.Enums.VirtualPrinterType.None:
                        postfix = ".prn";
        ...
        public void SelectViewSheetSet()
        {
            using (viewSheetSetForm dlg = new viewSheetSetForm(
                new ViewSheets(m_commandData.Application.ActiveDocument)))
            {
                dlg.ShowDialog();
            }
        }
        ...
        public bool VerifyPrintToSeparateFile(System.Windows.Forms.Control controlToEnableOrNot)
        {
            ...
            return controlToEnableOrNot.Enabled = ((m_printMgr.IsVirtual != VirtualPrinterType.None
                && m_printMgr.PrintRange == Autodesk.Revit.Enums.PrintRange.Select)
                || (m_printMgr.IsVirtual == VirtualPrinterType.None
                && m_printMgr.PrintRange == Autodesk.Revit.Enums.PrintRange.Select
                && m_printMgr.PrintToFile));
        }
        ...
        public bool VerifyCollate(System.Windows.Forms.Control controlToEnableOrNot)
        {
            ...
            return controlToEnableOrNot.Enabled = m_printMgr.PrintRange == Autodesk.Revit.Enums.PrintRange.Select
                && !m_printMgr.PrintToFile
                && cn > 1;
        }
        ...
        public bool VerifySelectViewSheetSet(Collection<System.Windows.Forms.Control> controlsToEnableOrNot)
        {
            ...
            bool enableOrNot = m_printMgr.PrintRange == Autodesk.Revit.Enums.PrintRange.Select;
            foreach (System.Windows.Forms.Control control in controlsToEnableOrNot)
            {
                control.Enabled = enableOrNot;
            }
