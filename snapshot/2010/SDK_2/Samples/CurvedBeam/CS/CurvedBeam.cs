...
namespace Revit.SDK.Samples.CurvedBeam.CS
{
    ...
    public class Command : IExternalCommand
    {
        ...
        Arc CreateArc()
        {
            ...
            return m_revit.Create.NewArc(center, radius, startAngle, endAngle, xAxis, yAxis);
        }
        ...
        Ellipse CreateEllipse()
        {
            ...
            return m_revit.Create.NewEllipse(center, radX, radY, xVec, yVec, param0, param1);
        }
        ...
        NurbSpline CreateNurbSpline()
        {
            ...
            ctrPoints.Append(xyz1); ctrPoints.Append(xyz2); ctrPoints.Append(xyz3);
        ...
        public bool CreateCurvedBeam(FamilySymbol fsBeam, Curve curve, Level level, XYZ position)
        {
            ...
            {
                XYZ center = new XYZ(0, 0, 0);
                beam = m_revit.ActiveDocument.Create.NewFamilyInstance(center, fsBeam, level, StructuralType.Beam);
                if (null == beam)
                {
                    return false;
                }
            ...
            m_revit.ActiveDocument.Move(beam, position);
            return true;
        }
    }
