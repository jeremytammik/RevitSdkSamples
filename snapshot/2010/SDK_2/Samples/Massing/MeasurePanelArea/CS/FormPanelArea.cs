...
using Panel = Autodesk.Revit.Elements.Panel;
...
namespace Revit.SDK.Samples.MeasurePanelArea.CS
{
   ...
   public partial class frmPanelArea : System.Windows.Forms.Form
   {
      ...
      private void BuildPanelTypeList()
      {
         ...
         string famDelimiter = ":";
         foreach (Autodesk.Revit.Symbols.FamilySymbol famSymbol in fs.Family.Symbols)
         {
      ...
      private void GetDividedSurfaces()
      {
         ...
         if (m_doc.Selection.Elements.Size == 0)
         {
         ...
         foreach (Element element in m_doc.Selection.Elements)
         {
      ...
      private double GetAreaOfTileInstance(FamilyInstance familyinstance)
      {
         ...
         foreach (GeometryObject geomObject1 in geomElem.Objects)
         {
            ...
            else if (geomObject1 is Instance)
            {
            ...
            {
               panelArea = face.Area;
               m_writeFile.WriteLine(familyinstance.Id.Value + " : " + panelArea);
            }
         }
         return panelArea;
      }
