...
namespace Revit.SDK.Samples.VisibilityControl.CS
{
    ...
    public class VisibilityCtrl
    {
        ...
        public VisibilityCtrl(Autodesk.Revit.Document document)
        {
            if (null == document)
            {
            ...
            {
                if(category.get_AllowsVisibilityControl(m_document.ActiveView))
                {
        ...
        public void Isolate()
        {
            ...
            Autodesk.Revit.ElementSet elements = m_document.Selection.Elements;

            // hide all categories elements
            foreach (Category cat in m_document.Settings.Categories)
            {
