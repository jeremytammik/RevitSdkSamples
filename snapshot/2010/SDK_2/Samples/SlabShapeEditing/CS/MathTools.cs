...
namespace Revit.SDK.Samples.SlabShapeEditing.CS
{
    ...
    public class Vector4
    {
        ...
        /// <summary>
        /// constructor, transfer XYZ to vector
        /// </summary>
        /// <param name="v">XYZ structure which needs to be transfered</param>
    ...
    public class Matrix4
    {
        ...
        /// <summary>
        /// get a matrix used to rotate object specfic angle on X direction
        /// </summary>
        /// <param name="angle">rotate angle</param>
        /// <returns>matrix which rotate object specfic angle on X direction</returns>
        ...
        /// <summary>
        /// get a matrix used to rotate object specfic angle on Y direction
        /// </summary>
        /// <param name="angle">rotate angle</param>
        /// <returns>matrix which rotate object specfic angle on Y direction</returns>
        ...
        /// <summary>
        /// get a matrix used to rotate object specfic angle on Z direction
        /// </summary>
        /// <param name="angle">rotate angle</param>
        /// <returns>matrix which rotate object specfic angle on Z direction</returns>
