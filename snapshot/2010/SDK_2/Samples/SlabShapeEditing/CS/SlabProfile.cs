...
namespace Revit.SDK.Samples.SlabShapeEditing.CS
{
    ...
    class SlabProfile
    {
        ...
        Autodesk.Revit.Elements.Floor m_floor; //object of truss in Revit
        ...
        public SlabProfile(Autodesk.Revit.Elements.Floor floor, ExternalCommandData commandData)
        {
            m_floor = floor;
        ...
        public EdgeArray GetFloorEdges() 
        {
            ...
            Options options = m_commandData.Application.Create.NewGeometryOptions();
            options.DetailLevel = Options.DetailLevels.Medium;
            //make sure references to geometric objects are computed.
            options.ComputeReferences = true;
            Autodesk.Revit.Geometry.Element geoElem = m_floor.get_Geometry(options);
        ...
        public void DrawCurve(Graphics graphics, Pen pen, XYZArray points)
        {
            //draw slab curves
        ...
        /// <summary>
        /// rotate slab with specfic angle
        /// </summary>
        ...
        /// <summary>
        /// Add vertex on specfic location
        /// </summary>
        ...
        {
            m_commandData.Application.ActiveDocument.BeginTransaction();
            Vector4 v1 = new Vector4(new XYZ(point.X, point.Y, 0));
            v1 = m_restoreMatrix.Transform(v1);
            SlabShapeVertex vertex = m_slabShapeEditor.DrawPoint(new XYZ(v1.X, v1.Y, v1.Z));
            m_commandData.Application.ActiveDocument.EndTransaction();
            //re-calculate geometry info
            GetSlabProfileInfo();
        ...
        /// <summary>
        /// Add Crease on specfic location
        /// </summary>
        ...
        public SlabShapeCrease AddCrease(PointF point1, PointF point2)
        {
            //create first vertex
            m_commandData.Application.ActiveDocument.BeginTransaction();
            Vector4 v1 = new Vector4(new XYZ(point1.X, point1.Y, 0));
            v1 = m_restoreMatrix.Transform(v1);
            SlabShapeVertex vertex1 = m_slabShapeEditor.DrawPoint(new XYZ(v1.X, v1.Y, v1.Z));
            //create second vertex
            Vector4 v2 = new Vector4(new XYZ(point2.X, point2.Y, 0));
            v2 = m_restoreMatrix.Transform(v2);
            SlabShapeVertex vertex2 = m_slabShapeEditor.DrawPoint(new XYZ(v2.X, v2.Y, v2.Z));
            //create crease
        ...
        public bool CanCreateVertex(PointF pointF)
        {
            ...
            m_commandData.Application.ActiveDocument.BeginTransaction();
            Vector4 v1 = new Vector4(new XYZ(pointF.X, pointF.Y, 0));
            v1 = m_restoreMatrix.Transform(v1);
            SlabShapeVertex vertex = m_slabShapeEditor.DrawPoint(new XYZ(v1.X, v1.Y, v1.Z));
