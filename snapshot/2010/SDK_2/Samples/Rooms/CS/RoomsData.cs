...
namespace Revit.SDK.Samples.Rooms.CS
{
    ...
    public class RoomsData
    {
        ...
        public struct DepartmentInfo
        {
            ...
            /// <summary>
            /// get the amount of rooms in the deparetment
            /// </summary>
        ...
        public void CreateTags()
        {
            try
            {
                foreach (Room tmpRoom in m_roomsWithoutTag)
                {
                    ...
                    if (null == locPoint)
                    {
                        String roomId = "Room Id:  " + tmpRoom.Id.Value.ToString();
                    ...
                    //create room tag
                    RoomTag tmpTag;
                    tmpTag = m_revit.ActiveDocument.Create.NewRoomTag(tmpRoom, point, null);
                    if (null != tmpTag)
                    {
        ...
        public void ReorderRooms()
        {
            ...
            if (!result)
            {
                MessageBox.Show("Fault to reorder rooms' number,can't get location point!", "Revit");
                return;
            }
            ...
            // display a message box
            MessageBox.Show("Reorder room's number complete!", "Revit");
        }
        ...
        public void ExportFile(String fileName)
        {
            ...
            String projectTitle = m_revit.ActiveDocument.Title;  //the name of the project
