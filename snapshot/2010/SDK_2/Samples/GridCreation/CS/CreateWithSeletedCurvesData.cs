...
namespace Revit.SDK.Samples.GridCreation.CS
{
    ...
    public class CreateWithSelectedCurvesData : CreateGridsData
    {
        ...
        public CreateWithSelectedCurvesData(Application application, CurveArray selectedCurves, ArrayList labels)
        ...
        public void CreateGrids()
        {
            ...
            if (m_deleteSelectedElements)
            {
                try
                {
                    m_revitDoc.Delete(Command.GetSelectedModelLinesAndArcs(m_revitDoc));
                }
                catch(Exception)
                {
