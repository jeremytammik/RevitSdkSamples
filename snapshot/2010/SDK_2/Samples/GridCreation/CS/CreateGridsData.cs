...
namespace Revit.SDK.Samples.GridCreation.CS
{
    ...
    public class CreateGridsData
    {
        ...
        /// </summary>
        protected Autodesk.Revit.Document m_revitDoc;
        /// <summary>
        ...
        public CreateGridsData(Application application, ArrayList labels)
        {
            m_revitDoc = application.ActiveDocument;
            m_appCreator = application.Create;
            m_docCreator = application.ActiveDocument.Create;
            m_labelsList = labels;
        }
        ...
        public CreateGridsData(Application application, ArrayList labels, DisplayUnitType dut)
        {
            m_revitDoc = application.ActiveDocument;
            m_appCreator = application.Create;
            m_docCreator = application.ActiveDocument.Create;
        ...
        protected void TransformCircle(Arc arc, ref Arc upperArc, ref Arc lowerArc, BubbleLocation bubLoc)
        {
            ...
            XYZ XRightPoint = new XYZ(center.X + radius, center.Y, 0);
            XYZ XLeftPoint = new XYZ(center.X - radius, center.Y, 0);
            XYZ YUpperPoint = new XYZ(center.X, center.Y + radius, 0);
            XYZ YLowerPoint = new XYZ(center.X, center.Y - radius, 0);
            if (bubLoc == BubbleLocation.StartPoint)
            {
        ...
        {
            return m_appCreator.NewLineBound(start, end);
        }
