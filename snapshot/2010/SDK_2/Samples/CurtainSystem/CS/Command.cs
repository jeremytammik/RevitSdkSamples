...
namespace Revit.SDK.Samples.CurtainSystem.CS
{
    ...
    class Command : IExternalCommand
    {
        ...
        public IExternalCommand.Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            Data.Document document = new Data.Document(commandData);

            using (UI.CurtainForm curtainForm = new UI.CurtainForm(document))
            {
                // check whether the mass is kind of parallelepiped
                CurtainSystem.MassChecker checker = new CurtainSystem.MassChecker(document);
                checker.CheckSelectedMass();
