...
namespace Revit.SDK.Samples.CurtainSystem.CS.CurtainSystem
{
    ...
    class MassChecker
    {
        ...
        /// </param>
        public MassChecker(Data.Document doc)
        {
            m_document = doc;
        }
        ...
        public void CheckSelectedMass()
        {
            ...
            if (null == mass)
            {
                m_document.FatalErrorMsg = Properties.Resources.MSG_InvalidSelection;
                return;
            }
        ...
        private bool IsMassParallelepiped(FamilyInstance mass)
        {
            ...
            {
                m_document.MassFaceArray = faces;
            }
        ...
        {
            XYZArray pointsA = edgeA.Tessellate();
            XYZArray pointsB = edgeB.Tessellate();
            XYZ vectorA = pointsA.get_Item(1) - pointsA.get_Item(0);
            XYZ vectorB = pointsB.get_Item(1) - pointsB.get_Item(0);
        ...
        private FaceArray GetMassFaceArray(FamilyInstance mass)
        {
            ...
            Autodesk.Revit.Geometry.Options opt = m_document.CommandData.Application.Create.NewGeometryOptions();
            opt.DetailLevel = Autodesk.Revit.Geometry.Options.DetailLevels.Fine;
            opt.ComputeReferences = true;
            Autodesk.Revit.Geometry.Element geoElement = null;
            try
            {
        ...
        private FamilyInstance GetSelectedMass()
        {
            ...
            Selection selection = m_document.ActiveDocument.Selection;
            if (null == selection || 
            ...
            foreach (Autodesk.Revit.Element selElement in selection.Elements)
            {
