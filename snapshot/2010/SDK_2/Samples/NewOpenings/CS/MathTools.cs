...
namespace Revit.SDK.Samples.NewOpenings.CS
{
    ...
    public class Vector4
    {
        ...
        /// <summary>
        /// constructor, transfor XYZ to vector
        /// </summary>
    ...
    public class Matrix4
    {
        ...
        /// <returns></returns>
        public float this[int row,int colum]
        {
            get
            {
                return this.m_matrix[row, colum];
            }
            set
            {
                this.m_matrix[row, colum] = value;
            }
        }
        ...
        /// <summary>
        /// transfrom point use this matrix
        /// </summary>
        /// <param name="point">point needed to be thansform</param>
