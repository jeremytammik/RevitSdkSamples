...
namespace Revit.SDK.Samples.FrameBuilder.CS
{
    ...
    public class FrameTypesMgr
    {
        ...
        /// <returns></returns>
        public bool AddSymbol(Autodesk.Revit.Symbols.FamilySymbol framingSymbol)
        {
        ...
        public bool DeleteSymbol(FamilySymbol symbol)
        {
            ...
            {              
                ...
                // delete from Revit
                ElementIdSet ids = m_commandData.Application.ActiveDocument.Delete(symbol);
                if (ids.Size == 0)
                {
                    return false;
                }               
        ...
        public FamilySymbol DuplicateSymbol(Symbol framingSymbol, string symbolName)
        {
            // duplicate a FamilySymbol
            Symbol symbol = framingSymbol.Duplicate(GenerateSymbolName(symbolName));
