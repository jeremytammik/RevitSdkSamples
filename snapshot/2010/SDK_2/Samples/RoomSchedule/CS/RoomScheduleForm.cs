...
namespace Revit.SDK.Samples.RoomSchedule
{
    ...
    public partial class RoomScheduleForm : System.Windows.Forms.Form
    {
        ...
        public RoomScheduleForm(ExternalCommandData commandData)
        {
            ...
            m_document = m_commandData.Application.ActiveDocument;
            m_roomData = new RoomsData(commandData.Application.ActiveDocument);
        ...
        private void GetAllLevelsAndPhases()
        {
            ...
            Autodesk.Revit.TypeFilter tFilter = m_commandData.Application.Create.Filter.NewTypeFilter(typeof(Phase));
            ElementIterator iter = m_document.get_Elements(tFilter);
            iter.Reset();
            while (iter.MoveNext())
            {
        ...
        private bool CreateMyRoomSharedParameter()
        {
            ...
            try
            {
                ...
                revitApp.ActiveDocument.ParameterBindings.Insert(roomSharedParamDef, binding);
                return false;
            }
            catch (Exception ex)
            {
        ...
        private int RoomCreationStart()
        {
            ...
            try
            {
                ...
                foreach (Room room in m_roomData.Rooms)
                {
                    ...
                    {
                        existingRooms.Add(room.Id.Value, sharedParameter.AsString());
                    }
                }
