...
namespace Revit.SDK.Samples.CancelSave.CS
{
    ...
    public class CancelSave : IExternalApplication
    {
        ...
        public IExternalApplication.Result OnStartup(ControlledApplication application)
        {
            ...
            application.DocumentOpened   += new EventHandler<DocumentOpenedEventArgs>(ReservePojectOriginalStatus);
            application.DocumentCreated  += new EventHandler<DocumentCreatedEventArgs>(ReservePojectOriginalStatus);
            application.DocumentSaving   += new EventHandler<DocumentSavingEventArgs>(CheckProjectStatusUpdate);
            application.DocumentSavingAs += new EventHandler<DocumentSavingAsEventArgs>(CheckProjectStatusUpdate);
