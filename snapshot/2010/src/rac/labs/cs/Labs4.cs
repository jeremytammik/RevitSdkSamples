...
namespace Labs
{
  ...
  public class Lab4_4_1_PerDocParams : IExternalCommand
  {
      ...
      ElementSet elements )
    {
      ...
      // get or create the shared params group
      DefinitionGroup sharedParamsGroup = LabUtils.GetOrCreateSharedParamsGroup( sharedParamsFile, LabConstants.ParamGroupName );
      if( null == sharedParamsGroup )
      {
        message = "Error getting the shared params group.";
        return IExternalCommand.Result.Failed;
      ...
      // visible param
      Definition docParamDefVisible = LabUtils.GetOrCreateSharedParamsDefinition( sharedParamsGroup, ParameterType.Integer, LabConstants.ParamNameVisible, true );
      ...
      // invisible param
      Definition docParamDefInvisible = LabUtils.GetOrCreateSharedParamsDefinition( sharedParamsGroup, ParameterType.Integer, LabConstants.ParamNameInvisible, false );
  ...
  public class RevitCommand : IExternalCommand
  {
      ...
      ElementSet elements )
    {
      ...
      if( wall != null )
      {
        Parameter par = wall.get_Parameter(
          "APIParameter" );
  ...
  public class RevitCommand2 : IExternalCommand
  {
    public IExternalCommand.Result Execute(
      ExternalCommandData commandData,
      ref string messages,
  ...
  #endregion // Delete a parameter

  #region Shared parameter visibility
  public class RevitCommand3
  {
    public static bool isParameterVisible( Parameter p )
    {
      ...
      try
      {
        ...
        object result = t.InvokeMember( 
          "get_Visible", flags, null, p.Definition, null );
  ...
  #endregion // Shared parameter visibility
}
