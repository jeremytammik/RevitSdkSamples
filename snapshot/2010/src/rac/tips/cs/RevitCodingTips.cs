...
namespace RevitCodingTips
{
  ...
  public class CommandSuspendUpdatingDuringMirror : IExternalCommand
  {
      ...
      ElementSet elements )
    {
      ...
      //DetailCurve c1 = doc.Create.NewDetailCurve( doc.ActiveView, line, sketchPlane ); // jeremy 2009
      DetailCurve c1 = doc.Create.NewDetailCurve( doc.ActiveView, line ); // jeremy 2010
