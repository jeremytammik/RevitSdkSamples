...
namespace BuildingCoder
{
  class CmdNewSweptBlend
  {
      ...
      XYZ origin )
    {
      ...
      SketchPlane plane = doc.FamilyCreate.NewSketchPlane( geometryPlane );
      if( null == plane )
      {
    ...
    /// The NewSweptBlend method requires the input profile to be in the XY plane.
    /// </summary>
