...
namespace Revit.SDK.Samples.ViewPrinter.CS
{
    ...
    public class ViewSheets : ISettingNameOperation
    {
        ...
        public string SettingName
        {
            get
            {
                return m_viewSheetSetting.CurrentViewSheetSet.Name;
            }
            set
            {
        ...
        public List<Autodesk.Revit.Elements.View> AvailableViewSheetSet(VisibleType visibleType)
        {
            ...
            foreach (Autodesk.Revit.Elements.View view in m_viewSheetSetting.AvailableViews)
            {
        ...
        {
            foreach (Autodesk.Revit.Elements.View view in m_viewSheetSetting.CurrentViewSheetSet.Views)
            {
        ...
        public void ChangeCurrentViewSheetSet(List<string> names)
        {
            ...
            ViewSheetSet viewSheetSet = m_viewSheetSetting.CurrentViewSheetSet;
