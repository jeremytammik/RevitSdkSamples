        ...
        private void SetPanelVisibility(int panelNum)
        {
            switch (panelNum)
            {
                ...
                case 2:
                    ...
                    this.panel4.Visible = false;                    
                    this.Step1_BackButton.Enabled = false;
                    this.InputDimensionLabel.ForeColor = Color.Black;
                    this.InputDimensionLabel.Font = m_highFont;
                    this.WindowPropertyLabel.ForeColor = Color.Gray;
                    this.WindowPropertyLabel.Font = m_commonFont;
                    this.InputPathLabel.ForeColor = Color.Gray;
                ...
                case 3:
                    ...
                    this.WindowPropertyLabel.ForeColor = Color.Black;
                ...
                case 4:
                    ...
                    this.WindowPropertyLabel.ForeColor = Color.Gray;
                    this.WindowPropertyLabel.Font = m_commonFont;
                    this.InputPathLabel.ForeColor = Color.Black;
