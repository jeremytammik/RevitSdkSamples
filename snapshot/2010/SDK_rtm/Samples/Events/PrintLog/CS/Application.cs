...
namespace Revit.SDK.Samples.PrintLog.CS
{
    ...
    public class Application : IExternalApplication
    {
        ...
        public IExternalApplication.Result OnStartup(ControlledApplication application)
        {
            ...
            application.DocumentPrinting += new EventHandler<Autodesk.Revit.Events.DocumentPrintingEventArgs>(m_eventsReactor.AppDocumentPrinting);
            application.DocumentPrinted += new EventHandler<Autodesk.Revit.Events.DocumentPrintedEventArgs>(m_eventsReactor.AppDocumentPrinted);
