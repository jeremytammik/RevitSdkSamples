...
namespace Revit.SDK.Samples.PrintLog.CS
{
    ...
    public class Command: IExternalCommand
    {
            ...
            ref string message, ElementSet elements)
        {
            ...
            try
            {
                TypeFilter viewFilter = commandData.Application.Create.Filter.NewTypeFilter(typeof(View), true);
                IList<Element> viewElems = new List<Element>();
                document.get_Elements(viewFilter, viewElems);
                //
