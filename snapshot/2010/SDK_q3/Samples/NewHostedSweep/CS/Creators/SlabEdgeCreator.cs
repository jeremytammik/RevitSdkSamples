...
namespace Revit.SDK.Samples.NewHostedSweep.CS
{
    ...
    public class SlabEdgeCreator : HostedSweepCreator
    {
        ...
        public SlabEdgeCreator(Autodesk.Revit.Document rvtDoc)
            : base(rvtDoc)
        {
        }
        ...
        /// </summary>
        private Dictionary<Autodesk.Revit.Element, List<Edge>> m_floorSlabEdges;

        /// <summary>
        /// Filter all the edges from the element which SlabEdge can be created on.
        /// </summary>
        /// <param name="elem"></param>
        private void FilterEdgesForSlabEdge(Autodesk.Revit.Element elem)
        {
        ...
        {
            get { return m_rvtDoc.SlabEdgeTypes; }
        }
        ...
        public override Dictionary<Autodesk.Revit.Element, List<Edge>> SupportEdges
        {
            get
            {
                ...
                {
                    m_floorSlabEdges = new Dictionary<Autodesk.Revit.Element, List<Edge>>();
                    ElementIterator iter = m_rvtDoc.get_Elements(typeof(Floor));
                    while (iter.MoveNext())
                    {
