    ...
    public class GridCoordinates
    {
       ...
       private System.Drawing.Point m_center;
        ...
        private List<PointF> GetBoundsPoints()
        {
            ...
            foreach (XYZ point in m_drawing.Geometry.GridVertexesXYZ)
            {
        ...
        {
            XYZ startXYZ = m_myDocument.WallGeometry.StartXYZ;
            XYZ endXYZ = m_myDocument.WallGeometry.EndXYZ;
            Vector4 xAxis = new Vector4(new XYZ(endXYZ - startXYZ));
            xAxis.Normalize();
            //because in the windows UI, Y axis is downward
            Vector4 yAxis = new Vector4(new XYZ(0, 0, -1));
            yAxis.Normalize();
