...
namespace Revit.SDK.Samples.WindowWizard.CS
{
    ...
    class Utility
    {
        ...
        public static ReferencePlane GetRefPlaneByName(string name,Application app,Document doc)
        {
            ...
            ElementIterator eit = doc.get_Elements(app.Create.Filter.NewTypeFilter(typeof(ReferencePlane), true));
            eit.Reset();
            while (eit.MoveNext())
            {
        ...
        {
            View v = null;
            ElementIterator eit = doc.get_Elements(app.Create.Filter.NewTypeFilter(typeof(View), true));
            eit.Reset();
            while (eit.MoveNext())
            {
        ...
        public static List<T> GetElements<T>(Application app,Document doc) where T : Autodesk.Revit.Element
        {
            List<T> elements = new List<T>();
            ElementIterator eit = doc.get_Elements(app.Create.Filter.NewTypeFilter(typeof(T), true));
            eit.Reset();
            while (eit.MoveNext())
            {
