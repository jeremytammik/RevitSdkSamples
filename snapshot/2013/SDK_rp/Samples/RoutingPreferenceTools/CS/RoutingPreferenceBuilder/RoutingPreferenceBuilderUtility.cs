...
namespace Revit.SDK.Samples.RoutingPreferenceTools.CS
{
    ...
    internal class SchemaValidationHelper
    {
        ...
        private static string GetXmlSchema()
        {
            ...
            Stream schemaStream = System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("RoutingPreferenceTools.CS.RoutingPreferenceBuilder.RoutingPreferenceBuilderData.xsd");
