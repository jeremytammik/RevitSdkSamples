...
namespace RevitLookup.Test
{
   ...
   public class TestElements : RevitLookupTestFuncs
   {
      ...
      /// <summary>
      /// Creates 2 hardwired lines and a dimension 
      ...
      DimensionHardWired()
      {
        ...
        using( Transaction tx = new Transaction( doc ) ) // added by jeremy
        {
          tx.Start( "DimensionHardWired" ); // added by jeremy
