...
namespace REX.Start
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            RunExtension(@"c:\my documents\visual studio 2010\Projects\ContentGeneratorWPF\ContentGeneratorWPF\bin\Debug\ContentGeneratorWPF.dll", "2012");
        }

        static System.Reflection.Assembly currentDomain_AssemblyResolve(object sender, ResolveEventArgs args)
        {
            return Autodesk.REX.Framework.REXAssemblies.Resolve(sender, args, "2012", System.Reflection.Assembly.GetExecutingAssembly());
        }
