...
namespace Revit.SDK.Samples.RoutingPreferenceTools.CS
{
    ...
    internal class Convert
    {
        ...
        {
            FormatOptions formatOption = document.ProjectUnit.get_FormatOptions(UnitType.UT_PipeSize);
            return Autodesk.Revit.DB.IFC.ExporterIFCUtils.ConvertUnits(document, decimalFeet, formatOption.Units);
        }
