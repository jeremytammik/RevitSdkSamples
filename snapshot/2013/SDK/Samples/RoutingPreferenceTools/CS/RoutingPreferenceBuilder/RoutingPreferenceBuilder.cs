...
namespace Revit.SDK.Samples.RoutingPreferenceTools.CS
{
    ...
    public class RoutingPreferenceBuilder
    {
        ...
        public void ParseAllPipingPoliciesFromXml(XDocument xDoc)
        {
            ...
            FormatOptions formatOptionPipeSize = m_document.ProjectUnit.get_FormatOptions(UnitType.UT_PipeSize);

            string docPipeSizeUnit = formatOptionPipeSize.Units.ToString();
            ...
            FormatOptions formatOptionRoughness = m_document.ProjectUnit.get_FormatOptions(UnitType.UT_Piping_Roughness);

            string docRoughnessUnit = formatOptionRoughness.Units.ToString();
        ...
        public XDocument CreateXmlFromAllPipingPolicies()
        {
            ...
            FormatOptions formatOptionPipeSize = m_document.ProjectUnit.get_FormatOptions(UnitType.UT_PipeSize);
            string unitStringPipeSize = formatOptionPipeSize.Units.ToString();
            xroot.Add(new XAttribute(XName.Get("pipeSizeUnits"), unitStringPipeSize));

            FormatOptions formatOptionRoughness = m_document.ProjectUnit.get_FormatOptions(UnitType.UT_Piping_Roughness);
            string unitStringRoughness = formatOptionRoughness.Units.ToString();
            ...
            {
                xroot.Add(CreateXmlFromFamily(familySymbol, findFolderUtility));
            }
        ...
        /// <summary>
        /// Clear routing preference rules
        /// </summary>
        ...
        /// <summary>
        /// Parse pipe schedule type from Xml
        /// </summary>
        /// <param name="pipeScheduleTypeXElement"></param>
        ...
        /// <summary>
        /// Create Xml from pipe schedule type
        /// </summary>
        ...
        /// <summary>
        /// Parse routing preference manager from XML
        /// </summary>
        ...
        /// <summary>
        /// Create Xml from routing preference manager
        /// </summary>
        ...
        /// <summary>
        /// Parse routing preference rule from XML
        /// </summary>
        ...
        /// <summary>
        /// Create Xml from routing preference rule
        /// </summary>
        ...
        private XElement createXmlFromRoutingPreferenceRule(RoutingPreferenceRule rule, RoutingPreferenceRuleGroupType groupType)
        {
            ...
            {
                xRoutingPreferenceRule.Add(new XAttribute(XName.Get("minimumSize"), "All"));
                xRoutingPreferenceRule.Add(new XComment("Warning:  No criteria could be read.  Defaulting to 'All.'  This PipeType may have created in a non-MEP template.  Try adjusting the criteria via the UI or AddCriteria()."));
            }
