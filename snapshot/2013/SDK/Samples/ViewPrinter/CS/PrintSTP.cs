...
namespace Revit.SDK.Samples.ViewPrinter.CS
{
    ...
    public class PrintSTP : ISettingNameOperation
    {
        ...
        public int SettingCount
        {
            get
            {
                //return m_commandData.Application.ActiveUIDocument.Document.PrintSettings.Size; // removed by jeremy
                return m_commandData.Application.ActiveUIDocument.Document.GetPrintSettingIds().Count; // added by jeremy
            }
        }
        ...
        public List<string> PrintSettingNames
        {
            get
            {
                ...
                //foreach (Element printSetting in m_commandData.Application.ActiveUIDocument.Document.PrintSettings) // removed by jeremy

                foreach( ElementId printSettingId in m_commandData.Application.ActiveUIDocument.Document.GetPrintSettingIds() ) // added by jeremy
                {
                  Element printSetting = m_commandData.Application.ActiveUIDocument.Document.GetElement( printSettingId ); // added by jeremy
