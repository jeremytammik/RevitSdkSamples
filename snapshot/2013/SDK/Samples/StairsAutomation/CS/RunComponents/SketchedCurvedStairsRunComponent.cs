...
namespace Revit.SDK.Samples.StairsAutomation.CS
{
    ...
    class SketchedCurvedStairsRunComponent : TransformedStairsComponent, IStairsRunComponent
    {
        ...
        public IList<Autodesk.Revit.DB.Curve> GetStairsPath()
        {
            ...
            Arc arc = m_appCreate.NewArc(m_center, (m_innerRadius + m_outerRadius) / 2.0, 0, m_includedAngle, XYZ.BasisX, XYZ.BasisY);
            ret.Add(arc);
        ...
        public IList<Autodesk.Revit.DB.Curve> GetRunRiserCurves()
        {
            ...
            for (int i = 0; i < m_riserNumber - 1; i++)
            {
                ...
                ret.Add(Line.get_Bound(start, end));
            ...
            ret.Add(Line.get_Bound(boundaryCurves[0].Evaluate(1.0, true), boundaryCurves[1].Evaluate(1.0, true)));
        ...
        {
        	return GetRunBoundaryCurves()[1].get_EndPoint(1);
        }
        ...
        {
            List<Curve> ret = new List<Curve>();
            Arc arc = m_appCreate.NewArc(m_center, m_innerRadius, 0, m_includedAngle, XYZ.BasisX, XYZ.BasisY);
            ret.Add(arc);

            arc = m_appCreate.NewArc(m_center, m_outerRadius, 0, m_includedAngle, XYZ.BasisX, XYZ.BasisY);
            ret.Add(arc);
