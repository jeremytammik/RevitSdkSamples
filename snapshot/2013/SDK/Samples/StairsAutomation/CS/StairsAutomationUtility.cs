    ...
    public class StairsAutomationUtility
    {
        ...
        protected virtual IStairsConfiguration SetupHardcodedConfiguration()
        {
            switch (m_stairsNumber)
            {
                ...
                case 0:
                    {
                    var run =  new StairsSingleStraightRun(m_stairs, BottomLevel, Transform.get_Translation(new XYZ(100, 0, 0)));
                ...
                case 1:
                    ...
                    // Curve run 2 level
                case 2:
                    return new StairsSingleCurvedRun(m_stairs, BottomLevel, 3.0, Transform.get_Rotation(new XYZ(10, -20, 0), XYZ.BasisZ, Math.PI));
                    // Standard stair 1 level
                case 3:
                    {
                        StairsStandardConfiguration configuration = new StairsStandardConfiguration(m_stairs, BottomLevel, 1, Transform.get_Rotation(new XYZ(-20, -20, 0), XYZ.BasisZ, Math.PI/4.0));
                ...
                case 4:
                    {
                     StairsStandardConfiguration configuration = new StairsStandardConfiguration(m_stairs, BottomLevel, 3, Transform.get_Rotation(new XYZ(15, 10, 0), XYZ.BasisZ, 7.0 * Math.PI / 6.0));
                   ...
                   case 100:
                    {
                    	return  new StairsSingleSketchedStraightRun(m_stairs, BottomLevel, Transform.get_Translation(new XYZ(50, 0, 0)));
                    }
                   case 101:
                    {
                    	return new StairsSingleSketchedCurvedRun(m_stairs, BottomLevel, 6.0, Transform.get_Translation(new XYZ(-10, 0, 0)));
                    }
