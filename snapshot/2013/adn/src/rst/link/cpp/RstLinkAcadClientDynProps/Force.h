...
//-----------------------------------------------------------------------------
//----- Force.h : Declaration of the CForce
//-----------------------------------------------------------------------------
#pragma once
#include "resource.h"
...
//----- CForce
class ATL_NO_VTABLE CForce : 
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CForce, &CLSID_Force>,
	public ISupportErrorInfo,
	public IDispatchImpl<IForce, &IID_IForce, &LIBID_AsdkMiroLib, /*wMajor =*/ 2, /*wMinor =*/ 0>,
...
public:
	...
	DECLARE_REGISTRY_RESOURCEID(IDR_FORCE)

	BEGIN_COM_MAP(CForce)
		COM_INTERFACE_ENTRY(IForce)
...
OBJECT_ENTRY_AUTO(__uuidof(Force), CForce)
//MS
//OPM_DYNPROP_OBJECT_ENTRY_AUTO(CForce, AcDbLine)
//OPM_DYNPROP_OBJECT_ENTRY_AUTO(CForce, AcDbBlockReference)
