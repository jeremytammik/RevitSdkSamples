...
namespace RstLabs
{
  ...
  /// <summary>
  /// Lab 1-3 - More detailed info and modification of loads.
  /// </summary>
  [Transaction( TransactionMode.Automatic )]
  public class Lab1_3_ModifyLoads : IExternalCommand
  {
    Document _doc;
    ...
    public void ListAndModifyPointLoad( PointLoad ptLd )
    {
      ...
      try
      {
        ...
        // The following display name has no corresponding built-in parameter enum, but basically the same:
    ...
    public void ListAndModifyLineLoad( LineLoad lnLd, UIApplication app )
    {
      ...
      try
      {
        ...
        if( null != hostIdParam )
        {
          ...
          Element elem = app.ActiveUIDocument.Document.GetElement( hostId );
  ...
  public class Lab1_4_LoadTypes : IExternalCommand
  {
      ...
      ElementSet elements )
    {
      ...
      foreach( ElementType t in types )
      {
        ...
        famName = t.get_Parameter( 
          BuiltInParameter.SYMBOL_FAMILY_NAME_PARAM ).AsString();

        msg += "\r\n  " + t.Name 
          + ", Id=" + t.Id.IntegerValue.ToString() 
          + ", Family=" + famName;
      }
      RacUtils.InfoMsg( msg );
      ...
      foreach( ElementType ls1 in ptLdSymbs )
      {
        ...
        string scaleF = RacUtils.GetParameterValue( 
          ls1.get_Parameter( BuiltInParameter.LOAD_ATTR_FORCE_SCALE_FACTOR ) );

        msg += "\r\n  " + ls1.Name 
          + ", Id=" + ls1.Id.IntegerValue.ToString() 
          + ", Force Scale=" + scaleF;
      }
      RacUtils.InfoMsg( msg );
      return Result.Succeeded;
