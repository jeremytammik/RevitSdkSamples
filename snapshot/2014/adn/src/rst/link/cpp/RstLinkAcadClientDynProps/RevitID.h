...
//-----------------------------------------------------------------------------
//----- RevitID.h : Declaration of the CRevitID
//-----------------------------------------------------------------------------
#pragma once
#include "resource.h"
...
//----- CRevitID
class ATL_NO_VTABLE CRevitID : 
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CRevitID, &CLSID_RevitID>,
	public ISupportErrorInfo,
	public IDispatchImpl<IRevitID, &IID_IRevitID, &LIBID_AsdkMiroLib, /*wMajor =*/ 2, /*wMinor =*/ 0>,
...
public:
	...
	DECLARE_REGISTRY_RESOURCEID(IDR_REVITID)

	BEGIN_COM_MAP(CRevitID)
		COM_INTERFACE_ENTRY(IRevitID)
...
OBJECT_ENTRY_AUTO(__uuidof(RevitID), CRevitID)
OPM_DYNPROP_OBJECT_ENTRY_AUTO(CRevitID, AcDbLine)
OPM_DYNPROP_OBJECT_ENTRY_AUTO(CRevitID, AcDbBlockReference)
