        ...
        switch( param.AsInteger() )
        {
          ...
          case 1:
            ...
            sMsg += "\nLocation Line: start point: ("
                + RstUtils.PointString( curve.GetEndPoint( 0 ) ) + ")";
            // Get curve end point
            sMsg += ";  end point:(" + 
                    RstUtils.PointString( curve.GetEndPoint( 1 ) ) + ")";
            sMsg += "\n";
            break;
          case 2:
            ...
            for( int i = 0; i < bc.NumCurves; i++ )
            {
              ...
              // Get curve start point
              sMsg += "\nCurve start point:(" + 
                  RstUtils.PointString( areaCurve.GetEndPoint( 0 ) ) + ")";
              // Get curve end point
              sMsg += "; Curve end point:(" + 
                  RstUtils.PointString( areaCurve.GetEndPoint( 1 ) ) + ")";
            }
            sMsg += "\n";
            break;
          default:
