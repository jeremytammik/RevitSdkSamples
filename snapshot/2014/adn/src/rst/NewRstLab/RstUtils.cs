  ...
  static class RstUtils
  {
    ...
    public static string ListCurve( ref Curve crv )
    {
      ...
      if( crv is Line )
      {
        ...
        s += "  LINE: " + RstUtils.PointString( line.GetEndPoint( 0 ) )
          + " ; " + RstUtils.PointString( line.GetEndPoint( 1 ) ) + "\r\n";
      }
      else if( crv is Arc )
      {
        Arc arc = crv as Arc;
        s += "  ARC: " + RstUtils.PointString( arc.GetEndPoint( 0 ) )
          + " ; " + RstUtils.PointString( arc.GetEndPoint( 1 ) )
