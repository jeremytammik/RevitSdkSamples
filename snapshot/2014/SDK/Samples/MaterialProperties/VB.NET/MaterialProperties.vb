...
Public Class MaterialProperties
   ...
   End Function
    ...
    Private Function Init() As Boolean
        ...
        If m_revit.ActiveUIDocument.Selection.Elements.Size <> 1 Then
            Return False
        End If
    ...
    Private Sub GetSelectedComponent()
        Dim componentCollection As Autodesk.Revit.DB.ElementSet = m_revit.ActiveUIDocument.Selection.Elements
