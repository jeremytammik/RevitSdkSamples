...
namespace Revit.SDK.Samples.FrameBuilder.CS
{
    ...
    public class FrameBuilder
    {
        ...
        private FamilyInstance NewBeam(Autodesk.Revit.DB.UV point2D1, Autodesk.Revit.DB.UV point2D2, Level topLevel)
        {
            ...
            FamilyInstance beam = 
                m_docCreator.NewFamilyInstance(startPoint, m_data.BeamSymbol, topLevel, StructuralType.Beam);
        ...
        private List<FamilyInstance> NewBraces(Autodesk.Revit.DB.UV point2D1, Autodesk.Revit.DB.UV point2D2, Level baseLevel, Level topLevel)
        {
            ...
            FamilyInstance firstBrace = 
                m_docCreator.NewFamilyInstance(startPoint, m_data.BraceSymbol, StructuralType.Brace);
            ...
            FamilyInstance secondBrace = 
                m_docCreator.NewFamilyInstance(endPoint, m_data.BraceSymbol, StructuralType.Brace);
        ...
        /// <returns>is successful</returns>
        private bool SetLocationLine(ModelElement elem, Autodesk.Revit.DB.XYZ startPnt, Autodesk.Revit.DB.XYZ endPnt)
        {
            ...
            if (null != elemCurve && !elemCurve.IsReadOnly)
            {
                try
                {
                    Line line = m_appCreator.NewLineBound(startPnt, endPnt);
        ...
        /// <returns>is successful</returns>
        private bool MoveElement(Document doc, Autodesk.Revit.DB.Element elem, Autodesk.Revit.DB.UV translation2D)
        {
            Autodesk.Revit.DB.XYZ translation3D = new Autodesk.Revit.DB.XYZ (translation2D.U, translation2D.V, 0.0);
            return doc.Move(elem, translation3D);
        }
        ...
        /// <returns>is successful</returns>
        private bool RotateElement(UIApplication app, Autodesk.Revit.DB.Element elem, Autodesk.Revit.DB.UV center, double angle)
        {
            ...
            Line axis = app.Application.Create.NewLine(axisPnt1, axisPnt2,true);
            //axis.
            return app.ActiveUIDocument.Document.Rotate(elem, axis, angle);
        }
    }
}
