...
namespace Revit.SDK.Samples.CreateViewSection.CS
{
    ...
    public class Command : IExternalCommand
    {
        ...
        Transform GenerateWallTransform()
        {
            ...
            Autodesk.Revit.DB.XYZ basisZ = XYZMath.FindDirection(locationLine.get_EndPoint(0), locationLine.get_EndPoint(1));
        ...
        Transform GenerateBeamTransform()
        {
            ...
            Autodesk.Revit.DB.XYZ startPoint = curve.get_EndPoint(0);
            Autodesk.Revit.DB.XYZ endPoint = curve.get_EndPoint(1);
