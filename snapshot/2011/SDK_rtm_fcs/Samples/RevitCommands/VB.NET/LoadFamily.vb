...
Public Class RvtCmd_LoadFamilySymbol
    ...
    As Autodesk.Revit.UI.Result Implements Autodesk.Revit.UI.IExternalCommand.Execute
        ...
        If (commandData.Application.ActiveUIDocument.Document.LoadFamilySymbol(fileName, symName)) Then
...
Public Class RvtCmd_LoadFamily
    ...
    As Autodesk.Revit.UI.Result Implements Autodesk.Revit.UI.IExternalCommand.Execute
        ...
        If (rvtApp.ActiveUIDocument.Document.LoadFamily(fullPath)) Then
    ...
    As String
        ...
        Dim paths As StringStringMap = rvtApp.LibraryPaths
        Dim iter As StringStringMapIterator = paths.ForwardIterator
