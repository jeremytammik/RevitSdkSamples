    ...
    {      
        ...
        public static ViewSet GetAllViews (Document doc)
        {
            ...
            foreach (Element element in elements)
            {
               ...
               {
                  ElementType objType = view.ObjectType;
        ...
        GetAllSheets (Document doc)
        {
            ...
            foreach (Element element in elements)
            {
               ...
               {
                  ElementType objType = viewSheet.ObjectType;
                  if (null == objType)
                  {
                     continue;
                  }
        ...
        GetAvailableViewsToExport (Document doc)
        {
            ...
            /*ElementFilterIterator viewIter = m_revitApp.ActiveUIDocument.Document.get_Elements(typeof(Autodesk.Revit.DB.View));
