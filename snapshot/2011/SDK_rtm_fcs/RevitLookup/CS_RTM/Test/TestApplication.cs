...
{
    class TestApplication : RvtMgdDbgTestFuncs
    {
        public
        TestApplication (Autodesk.Revit.UI.UIApplication app)
            : base(app)
        {
            m_testFuncs.Add(new RvtMgdDbgTestFuncInfo("Batch Printing", "Prints all selected files in a batch process", typeof(Autodesk.Revit.ApplicationServices.Application), new RvtMgdDbgTestFuncInfo.TestFunc(BatchPrinting), RvtMgdDbgTestFuncInfo.TestType.Other));
            m_testFuncs.Add(new RvtMgdDbgTestFuncInfo("Journal Playback", "Plays back a selected journal", typeof(Autodesk.Revit.ApplicationServices.Application), new RvtMgdDbgTestFuncInfo.TestFunc(JournalPlayBack), RvtMgdDbgTestFuncInfo.TestType.Other));
        }
