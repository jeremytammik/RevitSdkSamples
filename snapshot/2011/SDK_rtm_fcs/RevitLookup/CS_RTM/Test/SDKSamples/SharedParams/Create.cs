...
namespace RvtMgdDbg.Test.SDKSamples.SharedParams
{
   ...
   class Create
   {
      ...
      const string m_sharedParamFile = "RvtMgdDbg.txt";   // use this name if there isn't already a shared param file
      const string m_paramGroupName = "RvtMgdDbg";
      const string m_paramName = "Message from RvtMgdDbg";
