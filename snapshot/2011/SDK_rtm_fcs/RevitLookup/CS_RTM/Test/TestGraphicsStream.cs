...
namespace RvtMgdDbg.Test {
    ...
    class TestGraphicsStream : RvtMgdDbgTestFuncs {
            ...
            : base(app)
        {
            ...
            m_testFuncs.Add(new RvtMgdDbgTestFuncInfo("Graphics Stream (Element, Xform)", "Select an Element and stream out its graphics as Model Lines, offset by an Xform", "Graphics Streams", new RvtMgdDbgTestFuncInfo.TestFunc(GraphicsStreamElementXform), RvtMgdDbgTestFuncInfo.TestType.Create));
            m_testFuncs.Add(new RvtMgdDbgTestFuncInfo("Curtain System to Wireframe", "Convert a Curtain System to Wireframe", "Graphics Streams", new RvtMgdDbgTestFuncInfo.TestFunc(CurtainSystemToWireframe), RvtMgdDbgTestFuncInfo.TestType.Create));
        }
        ...
        {
            foreach (CurtainCell cell in grid.Cells) {
