...
namespace RvtMgdDbg.Test
{
   ...
   class TestDocument : RvtMgdDbgTestFuncs
   {
      ...
      TestDocument(Autodesk.Revit.UI.UIApplication app)
         : base(app)
      {
         m_testFuncs.Add(new RvtMgdDbgTestFuncInfo("Delete SelSet", "Delete the current SelSet", typeof(Document), new RvtMgdDbgTestFuncInfo.TestFunc(Delete), RvtMgdDbgTestFuncInfo.TestType.Modify));
         m_testFuncs.Add(new RvtMgdDbgTestFuncInfo("Move SelSet --> (10', 10', 0')", "Move the current SelSet", typeof(Document), new RvtMgdDbgTestFuncInfo.TestFunc(Move), RvtMgdDbgTestFuncInfo.TestType.Modify));
         m_testFuncs.Add(new RvtMgdDbgTestFuncInfo("Rotate SelSet by 45 degrees", "Rotate the current SelSet", typeof(Document), new RvtMgdDbgTestFuncInfo.TestFunc(Rotate), RvtMgdDbgTestFuncInfo.TestType.Modify));
         m_testFuncs.Add(new RvtMgdDbgTestFuncInfo("Load Family", "Load a .rfa file", typeof(Document), new RvtMgdDbgTestFuncInfo.TestFunc(LoadFamily), RvtMgdDbgTestFuncInfo.TestType.Modify));
         m_testFuncs.Add(new RvtMgdDbgTestFuncInfo("Linear Array SelSet (Number = 4)", "Linearly array the current SelSet", typeof(Document), new RvtMgdDbgTestFuncInfo.TestFunc(LinearArray), RvtMgdDbgTestFuncInfo.TestType.Modify));
         m_testFuncs.Add(new RvtMgdDbgTestFuncInfo("Radial Array SelSet by 30 degrees (Number = 4)", "Radially array the current SelSet", typeof(Document), new RvtMgdDbgTestFuncInfo.TestFunc(RadialArray), RvtMgdDbgTestFuncInfo.TestType.Modify));
         m_testFuncs.Add(new RvtMgdDbgTestFuncInfo("Linear Array SelSet without associate", "Linearly array the current SelSet without associate", typeof(Document), new RvtMgdDbgTestFuncInfo.TestFunc(ArrayWithoutAssociate), RvtMgdDbgTestFuncInfo.TestType.Modify));
         ...
         m_testFuncs.Add(new RvtMgdDbgTestFuncInfo("Boundary Lines", "Draw lines to sketch the Room Boundary", typeof(Document), new RvtMgdDbgTestFuncInfo.TestFunc(SketchBoundary), RvtMgdDbgTestFuncInfo.TestType.Create));
         m_testFuncs.Add(new RvtMgdDbgTestFuncInfo("Room Area", "Insert Area Value textnotes for all available rooms", typeof(Document), new RvtMgdDbgTestFuncInfo.TestFunc(RoomArea), RvtMgdDbgTestFuncInfo.TestType.Create));
         m_testFuncs.Add(new RvtMgdDbgTestFuncInfo("Filter Element types", "Filter for selected element types", typeof(Document), new RvtMgdDbgTestFuncInfo.TestFunc(FilterElementTypes), RvtMgdDbgTestFuncInfo.TestType.Query));
         m_testFuncs.Add(new RvtMgdDbgTestFuncInfo("Add family types and parameters", "Use family manager for adddition of types/params", typeof(Document), new RvtMgdDbgTestFuncInfo.TestFunc(AddFamilyParameterAndType), RvtMgdDbgTestFuncInfo.TestType.Create));
      }
      ...
      public void AddFamilyParameterAndType()
      {
         ...
         { // has to be a family document to be able to use the Family Manager.
            ...
            //Add a family param. 
            FamilyParameter famParam = famMgr.AddParameter("RvtMgdDbg_Param", BuiltInParameterGroup.PG_TITLE, ParameterType.Text, false);
            ...
            FamilyType newFamType = famMgr.NewType("RvtMgdDbg_Type1");
            ...
            FamilyType newFamType1 = famMgr.NewType("RvtMgdDbg_Type2");
            famMgr.CurrentType = newFamType;
