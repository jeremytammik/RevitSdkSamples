   ...
   public class CmdSnoopDb : IExternalCommand
   {
      public Autodesk.Revit.UI.Result Execute(Autodesk.Revit.UI.ExternalCommandData cmdData, ref string msg, ElementSet elems)
      {
         ...
         try
         {
            ...
            FilteredElementCollector collector = new FilteredElementCollector(cmdData.Application.ActiveUIDocument.Document);
   ...
   public class CmdSnoopModScope : IExternalCommand
   {
      public Autodesk.Revit.UI.Result Execute(Autodesk.Revit.UI.ExternalCommandData cmdData, ref string msg, ElementSet elems)
      {
         ...
         try
         {
            ...
            Snoop.Forms.Objects form = new Snoop.Forms.Objects(cmdData.Application.ActiveUIDocument.Selection.Elements);
            form.ShowDialog();
