...
namespace RvtMgdDbg.Snoop.CollectorExts
{
    ...
    public class CollectorExtCreation : CollectorExt
    {
        ...
        CollectEvent(object sender, CollectorEventArgs e)
        {
            ...
            RoomCreationData roomData = e.ObjToSnoop as RoomCreationData;
            if (roomData != null) {
                Stream(snoopCollector.Data(), roomData);
                return;
            }
        ...
        private void
        Stream(ArrayList data, RoomCreationData roomData)
        {
            data.Add(new Snoop.Data.ClassSeparator(typeof(RoomCreationData)));

            data.Add(new Snoop.Data.Object("Tag point", roomData.TagPoint));            
        }
