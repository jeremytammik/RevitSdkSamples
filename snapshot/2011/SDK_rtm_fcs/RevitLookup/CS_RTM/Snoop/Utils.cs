...
namespace RvtMgdDbg.Snoop
{
	...
	public class Utils
	{
        ...
        BrowseReflection(Object obj)
        {
            ...
            RvtMgdDbg.Snoop.Forms.GenericPropGrid pgForm = new RvtMgdDbg.Snoop.Forms.GenericPropGrid(obj);
        ...
        PrintMenuItemClick (PrintDialog dlg, TreeView tv)
        {
            if (tv.SelectedNode == null)
            {
                MessageBox.Show(tv.Parent, "Please select a node in the tree to print.", "RvtMgdDbg", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
