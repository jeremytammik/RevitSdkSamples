...
namespace RvtMgdDbg.EventTrack.Events {
    ...
    public class ApplicationEvents : EventsBase {
        ...
        EnableEventsImp()
        {           
            MessageBox.Show("Application Events Turned On ...", "RvtMgdDbg", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        DisableEventsImp ()
        {            
            MessageBox.Show("Application Events Turned Off ...", "RvtMgdDbg", MessageBoxButtons.OK, MessageBoxIcon.Information);
