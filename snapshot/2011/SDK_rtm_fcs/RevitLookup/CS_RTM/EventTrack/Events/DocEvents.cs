...
namespace RvtMgdDbg.EventTrack.Events
{
    ...
    public class DocEvents : EventsBase
    {
        ...
        EnableEventsImp()
        {
            MessageBox.Show("Document Events Turned On ...", "RvtMgdDbg", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        DisableEventsImp()
        {
            MessageBox.Show("Document Events Turned Off ...", "RvtMgdDbg", MessageBoxButtons.OK, MessageBoxIcon.Information);
