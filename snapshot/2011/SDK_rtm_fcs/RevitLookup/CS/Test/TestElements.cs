...
namespace RevitLookup.Test {
    ...
    public class TestElements : RevitLookupTestFuncs
    {
        ...
        {
            return window.Document.get_Element(window.GetTypeId()).get_Parameter(BuiltInParameter.WINDOW_HEIGHT).AsDouble();
        }
        ...
        public void ClassRoom ()
        {
           ...
           foreach (Element element in elements)
           {
            ...
            Autodesk.Revit.Collections.StringStringMapIterator iter = m_revitApp.Application.LibraryPaths.ForwardIterator();
            ...
            foreach (Element element in levels)
           {
            ...
            Line line1 = m_revitApp.Application.Create.NewLine(startPt1, endPt1, true);

            XYZ startPt2 = endPt1;
            XYZ endPt2 = new XYZ(56.5, 61.5, 0.0);
            Line line2 = m_revitApp.Application.Create.NewLine(startPt2, endPt2, true);

            XYZ startPt3 = endPt2;
            XYZ endPt3 = new XYZ(0.0, 61.5, 0.0);
            Line line3 = m_revitApp.Application.Create.NewLine(startPt3, endPt3, true);

            XYZ startPt4 = endPt3;
            XYZ endPt4 = startPt1;
            Line line4 = m_revitApp.Application.Create.NewLine(startPt4, endPt4, true);
           ...
           foreach (Element element in wallTypes)
           {
            ...
            // draw 4 walls
            Wall wall1 = m_revitApp.ActiveUIDocument.Document.Create.NewWall(line1, outerWallType, level1, 7.0, 0.0, false, false);
            Wall wall2 = m_revitApp.ActiveUIDocument.Document.Create.NewWall(line2, curtainWallType, level1, 7.0, 0.0, false, false);
            Wall wall3 = m_revitApp.ActiveUIDocument.Document.Create.NewWall(line3, curtainWallType, level1, 7.0, 0.0, false, false);
            Wall wall4 = m_revitApp.ActiveUIDocument.Document.Create.NewWall(line4, curtainWallType, level1, 7.0, 0.0, false, false);
            ...
            for (int i = 0; i < row; i++) {
                ...
                for (int j = 0; j < col; j++) {
                    ...
                    Line zAxis = m_revitApp.Application.Create.NewLineUnbound(pt, dir);
        ...
        SimpleShed ()
        {
           ...
           foreach (Element element in elements)
           {
            ...
            Wall windowHost = doc.NewWall(line, floorLevel, false);
            ...
            Wall wall2 = doc.NewWall(line1, floorLevel, false);
            ...
            Wall doorHost = doc.NewWall(line2, floorLevel, false);
            ...
            Wall wall4 = doc.NewWall(line3, floorLevel, false);
        ...
        Flip ()
        {
            ...
            while (elemSetIter.MoveNext()) {
                ...
                if (locCurve != null) {
                    ...
                    zAxis = m_revitApp.Application.Create.NewLineUnbound(flipPoint, zDir);
                }
            ...
            while (elemSetIter.MoveNext()) {
                ...
                if (hostObj != null) {
                    ...
                    if (floor != null) {
                        ...
                        options.DetailLevel = DetailLevels.Coarse;
                        ...
                        double absoluteElev = floor.Level.Elevation + floor.get_Parameter(BuiltInParameter.FLOOR_HEIGHTABOVELEVEL_PARAM).AsDouble();
                        ...
                        Floor floorClone = m_revitApp.ActiveUIDocument.Document.Create.NewFloor(mirroredCurveArray, floor.FloorType, floor.Level, false);
            ...
            while (elemSetIter.MoveNext()) {
                ...
                if (hostObj == null) {
                    ...
                    if (famInst != null) {
                        ...
                        FamilyInstance famInstClone = m_revitApp.ActiveUIDocument.Document.Create.NewFamilyInstance(pt, famInst.Symbol, elemHost, famInst.Level, famInst.StructuralType);
        ...
        AnnoSymbol ()
        {
            ...
            AnnotationSymbolTypeSet annoSymTypeSet = doc.AnnotationSymbolTypes;  
        ...
        BeamSystemHardWired ()
        {
            ...
            curveArray.Append(m_revitApp.Application.Create.NewLine(location1, location2, true));
            curveArray.Append(m_revitApp.Application.Create.NewLine(location2, location3, true));
            curveArray.Append(m_revitApp.Application.Create.NewLine(location3, location4, true));
            curveArray.Append(m_revitApp.Application.Create.NewLine(location4, location1, true));
            ...
            SketchPlane sketchPlane = m_revitApp.ActiveUIDocument.Document.Create.NewSketchPlane(plane);
            m_revitApp.ActiveUIDocument.Document.Create.NewBeamSystem(curveArray, sketchPlane, new XYZ(1.0, 1.0, 0.0), false);           
        }
        ...
        DetailCurveHardWired ()
        {
            ...
            curveArray.Append(m_revitApp.Application.Create.NewLine(location1, location2, true));
            curveArray.Append(m_revitApp.Application.Create.NewArc(location2, location3, ptOnCurve));

            // "a"
            XYZ center = new XYZ(10.0, -17.5, 0.0);
            XYZ xVec = GeomUtils.kXAxis;
            XYZ yVec = GeomUtils.kYAxis;
            Ellipse ellipse = m_revitApp.Application.Create.NewEllipse(center, 5.0, 8.0, xVec, yVec, 0.0, (GeomUtils.kRevitPi * 2.0));
            ...
            curveArray.Append(m_revitApp.Application.Create.NewArc(end0, end1, ptOnCurve));

            // "i"
            XYZ start = new XYZ(22.0, -12.5, 0.0);
            XYZ end = new XYZ(22.0, -25.0, 0.0);
            curveArray.Append(m_revitApp.Application.Create.NewLine(start, end, true));
        ...
        FoundationSlabHardWired ()
        {
           CurveArray curveArray = m_revitApp.Application.Create.NewCurveArray();
            ...
            FloorTypeSet floorTypeSet = m_revitApp.ActiveUIDocument.Document.FloorTypes;
        ...
        TextNoteHardWired ()
        {
            ...
            Line line = m_revitApp.Application.Create.NewLine(location1, location2, true);
            m_revitApp.ActiveUIDocument.Document.Create.NewWall(line, m_revitApp.ActiveUIDocument.Document.ActiveView.GenLevel, true);
        ...
        SimpleSlab ()
        {
            ...
            Level level = m_revitApp.ActiveUIDocument.Document.ActiveView.GenLevel;
            Line line = m_revitApp.Application.Create.NewLine(startPt, endPt, true);
        ...
        {                        
            ...
            ViewSection viewSec = m_revitApp.ActiveUIDocument.Document.Create.NewViewSection(doc.ActiveView.CropBox);
        ...
        FloorViewPlan ()
        {
            ...
            m_revitApp.ActiveUIDocument.Document.Create.NewViewPlan(viewName, doc.NewLevel(10.0), ViewPlanType.FloorPlan);
        }
        ...
        {          
            ...
            while (elemIter.MoveNext())
            {
                ...
                if (null != elem)
                {
                    m_revitApp.ActiveUIDocument.Document.Create.NewTag(view, elem, true, TagMode.TM_ADDBY_CATEGORY, TagOrientation.TAG_HORIZONTAL, tagLocation);            
                }
            }           
        }
        ...
        UpdateHostCompoudStructures (ElementType symbol)
        {
            ...
            foreach (CompoundStructureLayer layer in host.CompoundStructure.Layers) {        
