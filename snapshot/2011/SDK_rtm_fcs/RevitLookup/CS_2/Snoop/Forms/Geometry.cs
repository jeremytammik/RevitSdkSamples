...
namespace RevitLookup.Snoop.Forms
{
	...
	public class Geometry : RevitLookup.Snoop.Forms.ObjTreeBase
	{
      ...
      //geomOp.IncludeNonVisibleObjects = true; // jeremy
      TreeNode tmpNode;
      ...
      //geomOp2.IncludeNonVisibleObjects = true; // jeremy
