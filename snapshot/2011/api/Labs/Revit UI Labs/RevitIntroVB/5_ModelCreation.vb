...
Public Class ModelCreation
    ...
    Function CreateWalls_v1() As List(Of Wall)
        ...
        Dim level2 As Level = ElementFiltering.FindElement(_rvtDoc, GetType(Level), "Level 2")
        ...
        For i As Integer = 0 To 3
            ...
            Dim baseCurve As Line = _rvtApp.Create.NewLineBound(pts(i), pts(i + 1))
            ''  create a wall using the one of overloaded methods. 
            Dim aWall As Wall = _rvtDoc.Create.NewWall(baseCurve, level1, isStructural)
