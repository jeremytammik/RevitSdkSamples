...
Public Class ElementFiltering
    ...
    Public Sub ListFamilyTypes()
        ...
        '' 
        Dim wallTypes As WallTypeSet = _rvtDoc.WallTypes
        ...
        ''
        Dim floorTypes As FloorTypeSet = _rvtDoc.FloorTypes
        ...
        '' 
        Dim wallTypeCollector1 = New FilteredElementCollector(_rvtDoc)
        ...
        ''  using OfClass() 
        ''
        'Dim wallTypeCollector2 = New FilteredElementCollector(_rvtDoc)
        ...
        '' 
        'Dim wallTypeCollector3 = New FilteredElementCollector(_rvtDoc).OfClass(GetType(WallType))
        ...
        '' 
        Dim doorTypeCollector = New FilteredElementCollector(_rvtDoc)
    ...
    Sub ListInstances()
        ...
        Dim wallCollector = _
            New FilteredElementCollector(_rvtDoc).OfClass(GetType(Wall))
        ...
        Dim doorCollector = New FilteredElementCollector(_rvtDoc). _
    ...
    Sub FindFamilyType()
        ...
        FindFamilyType(_rvtDoc, GetType(WallType), wallFamilyName, wallTypeName)
        ...
        FindFamilyType(_rvtDoc, GetType(FamilySymbol), doorFamilyName, doorTypeName, BuiltInCategory.OST_Doors)
    ...
    Function FindFamilyType_Wall_v2(ByVal wallFamilyName As String, ByVal wallTypeName As String) As Element
        ...
        Dim wallTypeCollector2 = New FilteredElementCollector(_rvtDoc).OfClass(GetType(WallType))
    ...
    Function FindFamilyType_Door_v1(ByVal doorFamilyName As String, ByVal doorTypeName As String) As Element
        ...
        Dim doorFamilyCollector1 = New FilteredElementCollector(_rvtDoc)
    ...
    Function FindFamilyType_Door_v2(ByVal doorFamilyName As String, ByVal doorTypeName As String) As Element
        ...
        '' 
        Dim familyCollector = New FilteredElementCollector(_rvtDoc)
    ...
    Sub FindInstance()
        ...
        Dim idWallType As ElementId = FindFamilyType(_rvtDoc, GetType(WallType), wallFamilyName, wallTypeName).Id
        ...
        FindFamilyType(_rvtDoc, GetType(FamilySymbol), doorFamilyName, doorTypeName, BuiltInCategory.OST_Doors).Id
        ...
        '' 
        Dim level1 As Level = FindElement(_rvtDoc, GetType(Level), "Level 1")
    ...
    Function FindInstancesOfType(ByVal targetType As Type, _
        ...
        '' 
        Dim collector = New FilteredElementCollector(_rvtDoc).OfClass(targetType)
    ...
    Function FindLongWalls() As IList(Of Element)
        ...
        ''  first, narrow down to the elements of the given type and category 
        Dim collector = New FilteredElementCollector(_rvtDoc).OfClass(GetType(Wall))
