...
Public Class ElementModification
    ...
    Sub ModifyElementPropertiesWall(ByVal elem As Element)
        ...
        ElementFiltering.FindFamilyType(_rvtDoc, GetType(WallType), wallFamilyName, wallTypeName)
    ...
    Sub ModifyElementPropertiesDoor(ByVal elem As Element)
        ...
        ElementFiltering.FindFamilyType(_rvtDoc, GetType(FamilySymbol), _
    ...
    Sub ModifyElementByDocumentMethods(ByVal elem As Element)
        ...
        Dim pt1 = XYZ.Zero
        Dim pt2 = XYZ.BasisZ
        Dim axis As Line = _rvtApp.Create.NewLineBound(pt1, pt2)
