...
Public Class UISelection
    ...
    Public Function Execute(ByVal commandData As ExternalCommandData, _
        ...
        '' 
        Dim selSet As SelElementSet = _rvtUIDoc.Selection.Elements
        ...
        '' 
        'Dim ref As Reference = _rvtUIDoc.Selection.PickObject(ObjectType.Element, "Pick an element")
    ...
    Sub PickMethod_PickObject()
        ...
        Dim ref As Reference = _rvtUIDoc.Selection.PickObject(ObjectType.Element, "Select one element")
        Dim elem As Element = ref.Element
        ShowBasicElementInfo(elem)
    ...
    Sub PickMethod_PickObjects()
        ...
        Dim refs As IList(Of Reference) = _
            _rvtUIDoc.Selection.PickObjects(ObjectType.Element, "Select multiple elemens")
    ...
    Sub PickMethod_PickElementByRectangle()
        ...
        Dim elems As IList(Of Element) = _
            _rvtUIDoc.Selection.PickElementsByRectangle("Select by rectangle")
    ...
    Sub PickMethod_PickPoint()
        ...
        Dim pt As XYZ = _rvtUIDoc.Selection.PickPoint("Pick a point")
    ...
    Sub PickFace()
        ...
        Dim refFace As Reference = _rvtUIDoc.Selection.PickObject(ObjectType.Face, "Select a face")
    ...
    Sub PickEdge()
        ...
        Dim refEdge As Reference = _rvtUIDoc.Selection.PickObject(ObjectType.Edge, "Select an edge")
    ...
    Sub PickPointOnElement()
        ...
        Dim refPoint As Reference = _
            _rvtUIDoc.Selection.PickObject(ObjectType.PointOnElement, "Select a point on element")
    ...
    Sub PickWall()
        ...
        Dim ref As Reference = _rvtUIDoc.Selection.PickObject(ObjectType.Element, selFilterWall, "Select a wall")
    ...
    Sub PickPlanarFace()
        ...
        Dim ref As Reference = _rvtUIDoc.Selection.PickObject(ObjectType.Face, selFilterPlanarFace, "Select a planar face")
    ...
    Sub CancelSelection()
        ...
        Try
            Dim ref As Reference = _rvtUIDoc.Selection.PickObject(ObjectType.Element, "Select one element, or press [Esc] to cancel")
            Dim elem As Element = ref.Element
            ShowBasicElementInfo(elem)
...
Public Class CreateHouseUI
    ...
    Public Function Execute(ByVal commandData As ExternalCommandData, _
        ...
        CreateHouseInteractive(_rvtUIDoc)
