...
Public Class UIRibbon
    ...
    Const m_assembly As String = "D:\RevitAPI 2011 Training\Labs\Revit UI Labs\bin\Debug\RevitIntroVB.dll"
    Const m_imageFolder As String = "D:\RevitAPI 2011 Training\Labs\Revit UI Labs\bin\Debug\Images\"

    'Dim m_assembly As String = String.Empty
    'Dim m_imageFolder As String = String.Empty
    ...
    Sub AddRibbonSampler(ByVal app As UIControlledApplication)
        ...
        'm_assembly = [GetType].Assembly.Location
