...
namespace RevitIntroCS
{
  ...
  public class ElementFiltering : IExternalCommand
  {
    ...
    public void ListFamilyTypes()
    {
      ...
      //
      WallTypeSet wallTypes = _rvtDoc.WallTypes;
      ...
      //
      FloorTypeSet floorTypes = _rvtDoc.FloorTypes;
      ...
      //
      var wallTypeCollector1 = new FilteredElementCollector( _rvtDoc );
      ...
      // using OfClass()
      //
      //FilteredElementCollector wallTypeCollector2 = new FilteredElementCollector(_rvtDoc);
      ...
      //
      //FilteredElementCollector wallTypeCollector3 = new FilteredElementCollector(_rvtDoc).OfClass(typeof(WallType));
      ...
      //
      var doorTypeCollector = new FilteredElementCollector( _rvtDoc );
    ...
    public void ListInstances()
    {
      ...
      var wallCollector = new FilteredElementCollector( _rvtDoc ).OfClass( typeof( Wall ) );
      IList<Element> wallList = wallCollector.ToElements();

      ShowElementList( wallList, "Wall Instances: " );

      // list all the door instances
      var doorCollector = new FilteredElementCollector( _rvtDoc ).OfClass( typeof( FamilyInstance ) );
    ...
    public void FindFamilyType()
    {
      ...
      //
      ElementType wallType3 = ( ElementType ) FindFamilyType( _rvtDoc, typeof( WallType ), wallFamilyName, wallTypeName, null );

      msg = msg + ShowFamilyTypeAndId( "Find wall type (using generic function): ", wallFamilyAndTypeName, wallType3 ) + "\n";

      // (3.2) for the door type.
      //
      ElementType doorType3 = ( ElementType ) FindFamilyType( _rvtDoc, typeof( FamilySymbol ), doorFamilyName, doorTypeName, BuiltInCategory.OST_Doors );
    ...
    public Element FindFamilyType_Wall_v2( string wallFamilyName, string wallTypeName )
    {
      ...
      var wallTypeCollector2 = new FilteredElementCollector( _rvtDoc ).OfClass( typeof( WallType ) );
    ...
    public Element FindFamilyType_Door_v1( string doorFamilyName, string doorTypeName )
    {
      ...
      var doorFamilyCollector1 = new FilteredElementCollector( _rvtDoc );
    ...
    public Element FindFamilyType_Door_v2( string doorFamilyName, string doorTypeName )
    {
      ...
      //
      var familyCollector = new FilteredElementCollector( _rvtDoc );
    ...
    public void FindInstance()
    {
      ...
      ElementId idWallType = FindFamilyType( _rvtDoc, typeof( WallType ), wallFamilyName, wallTypeName, null ).Id;
      ...
      ElementId idDoorType = FindFamilyType( _rvtDoc, typeof( FamilySymbol ), doorFamilyName, doorTypeName, BuiltInCategory.OST_Doors ).Id;
      ...
      //
      Level level1 = ( Level ) FindElement( _rvtDoc, typeof( Level ), "Level 1", null );
    ...
    public IList<Element> FindInstancesOfType( Type targetType, ElementId idType, Nullable<BuiltInCategory> targetCategory )
    {
      ...
      //
      var collector = new FilteredElementCollector( _rvtDoc ).OfClass( targetType );
    ...
    public IList<Element> FindLongWalls()
    {
      ...
      // first, narrow down to the elements of the given type and category
      var collector = new FilteredElementCollector( _rvtDoc ).OfClass( typeof( Wall ) );
    ...
    // e.g.,
    // FindFamilyType(_rvtDoc, GetType(WallType), "Basic Wall", "Generic - 200mm")
    // FindFamilyType(_rvtDoc, GetType(FamilySymbol), "M_Single-Flush", "0915 x 2134mm", BuiltInCategory.OST_Doors)
    //
    //
    ...
    // e.g., FindElement(_rvtDoc, GetType(Level), "Level 1")
    //
