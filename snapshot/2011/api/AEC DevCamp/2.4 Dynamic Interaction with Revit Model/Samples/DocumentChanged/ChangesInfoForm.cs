...
namespace ChangesMonitor
{
    ...
    public partial class ChangesInformationForm : Form
    {
        ...
        internal void SetDataSource (DataTable dataBuffer)
        {
           changesdataGridView.DataSource = dataBuffer;
           changesdataGridView.AutoGenerateColumns = false;
        }
        ...
        private void ChangesInformationForm_Closed(object sender, EventArgs e)
        {
            return;
        }

        private void ChangesInformationForm_Load(object sender, EventArgs e)
        {
            return;
        }
    }
