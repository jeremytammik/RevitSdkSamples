...
namespace NewRstLab
{
  ...
  static class RstUtils
  {
    ...
    #region Get Element help functions.
      ...
      /// </summary>
    public static IList<Element> GetElementOfClass(Document doc, Type classType)
    {
    ...
    /// <summary>
    /// Helper funtion to ask user to pick an element with the specified promt string.
    ...
    public static FamilyInstance GetFamilyInstanceBySelection( 
        Document doc, UIApplication uiApp, 
        BuiltInCategory builtInCat, string sPrompt )
    {
      ...
      while( null == inst )
      {
        ...
        if( null != eRef && null != eRef.Element )
        {
          FamilyInstance instance = eRef.Element as FamilyInstance;
          if( null != instance )
          {
    ...
    public static ReferencePlane GetReferencePlaneBySelection( 
        Document doc, UIApplication uiApp, string sPrompt )
    {
      ...
      while( null == refPlane )
      {
        ...
        if( null != eRef && null != eRef.Element )
        {
          ReferencePlane rp = eRef.Element as ReferencePlane;
          if( null != rp )
          {
            refPlane = rp;
          }
