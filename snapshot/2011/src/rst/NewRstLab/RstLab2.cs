...
namespace NewRstLab
{
  ...
  // Note
  // Lab2_2_ListStructuralWall demonstrates the way to get all structural walls. 
  // Structural floor, structrual ContinuousFooting can be gotten in the same process.
  // Only need to replace class Wall with Floor/ContFooting. 
