...
/// ----------
///
/// In the previous labs, we learned the following:
///
...
///
/// To test this lab, open the family template "Metric Column.rft" and run the command.
///
/// Context:
/// --------
///
...
namespace FamilyLabsCS
{
  ...
  public class RvtCmd_FamilyCreateColumnVisibility : IExternalCommand
  {
    ...
    PlanarFace findFace( Extrusion pBox, XYZ normal, ReferencePlane refPlane )
    {
      ...
      Options op = _rvtApp.Create.NewGeometryOptions();
