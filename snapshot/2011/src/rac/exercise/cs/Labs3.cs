...
namespace Labs
{
  ...
  public class Lab3_4_ChangeSelectedInstanceType : IExternalCommand
  {
      ...
      ElementSet elements )
    {
      ...
      FamilyInstance inst = LabUtils.GetSingleSelectedElementOrPrompt(
      ...
      Dictionary<string, List<FamilySymbol>> mapFamilyToSymbols
