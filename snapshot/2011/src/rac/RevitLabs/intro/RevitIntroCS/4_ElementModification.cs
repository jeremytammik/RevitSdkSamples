...
namespace RevitIntroCS
{
  ...
  public class ElementModification : IExternalCommand
  {
    ...
    public void ModifyElementPropertiesWall(Element elem)
    {
      ...
      //' 
      Element newWallType = ElementFiltering.FindFamilyType(m_rvtDoc, typeof(WallType), wallFamilyName, wallTypeName, null);
      ...
      Line newWallLine = m_rvtApp.Create.NewLineBound(newPt1, newPt2);
    ...
    public void ModifyElementPropertiesDoor(Element elem)
    {
      ...
      //' To Do: change this to enhance import symbol later. 
      //' 
      Element newDoorType = ElementFiltering.FindFamilyType(m_rvtDoc, typeof(FamilySymbol), doorFamilyName, doorTypeName, BuiltInCategory.OST_Doors);
    ...
    public void ModifyElementByDocumentMethods(Element elem)
    {
      ...
      var pt1 = XYZ.Zero;
      var pt2 = XYZ.BasisZ;
      Line axis = m_rvtApp.Create.NewLineBound(pt1, pt2);
