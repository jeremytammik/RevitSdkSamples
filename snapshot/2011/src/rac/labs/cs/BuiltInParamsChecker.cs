...
namespace Labs
{
  ...
  public class BuiltInParamsChecker : IExternalCommand
  {
      ...
      ElementSet elements )
    {
      ...
      Element e = LabUtils.GetSingleSelectedElementOrPrompt( uidoc );
      ...
      if( e is FamilyInstance )
      {
        ...
        if( null != inst.Symbol )
        {
          string symbol_name = LabUtils.ElementDescription( inst.Symbol, true );
          family_name = LabUtils.ElementDescription( inst.Symbol.Family, true );
