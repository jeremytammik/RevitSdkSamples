...
namespace RevitCodingTips_cpp
{
  ...
  //
  public ref class CommandListWallInfo : public Autodesk::Revit::UI::IExternalCommand
  {
  public:
  ...
  private:
    System::String ^ ListWallFamilyAndTypeInfo( Autodesk::Revit::DB::Element ^, System::String ^% );
    System::String ^ ListParameters( Autodesk::Revit::DB::Element ^ );
  };
}
