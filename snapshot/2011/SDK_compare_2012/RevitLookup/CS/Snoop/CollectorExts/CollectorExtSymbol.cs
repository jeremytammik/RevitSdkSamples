...
namespace RevitLookup.Snoop.CollectorExts
{
   ...
   public class CollectorExtSymbol : CollectorExt
   {
      ...
      Stream(ArrayList data, ElementType sym)
      {
         ...
         PipeConnectionType pipeConnType = sym as PipeConnectionType;
         if (pipeConnType != null)
         {
            Stream(data, pipeConnType);
            return;
         }

         PipeMaterialType pipeMatType = sym as PipeMaterialType;
         if (pipeMatType != null)
         {
            Stream(data, pipeMatType);
            return;
         }
      ...
      Stream(ArrayList data, HostObjAttributes hostAtt)
      {
         ...
         data.Add(new Snoop.Data.Object("Compound structure", hostAtt.CompoundStructure));
      ...
      Stream(ArrayList data, FamilySymbol famSym)
      {
         ...
         data.Add(new Snoop.Data.Enumerable("Material", famSym.Materials));
      ...
      Stream(ArrayList data, RebarShape rebarShape)
      {
         ...
         data.Add(new Snoop.Data.Object("Definition", rebarShape.Definition));
      ...
      Stream(ArrayList data, PipeType pipeType)
      {
         ...
         data.Add(new Snoop.Data.Object("Connection type", pipeType.ConnectionType));
         data.Add(new Snoop.Data.Object("Material", pipeType.Material));
      }
      ...
      private void
      Stream(ArrayList data, PipeConnectionType pipeConnType)
      {
         data.Add(new Snoop.Data.ClassSeparator(typeof(PipeConnectionType)));

         // Nothing at this level yet
      }

      private void
      Stream(ArrayList data, PipeMaterialType pipeMatType)
      {
         data.Add(new Snoop.Data.ClassSeparator(typeof(PipeMaterialType)));
