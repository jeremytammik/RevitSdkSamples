...
namespace Revit.SDK.Samples.AddSpaceAndZone.CS
{
    ...
    class SpaceManager
    {
        ...
        public void CreateSpaces(Level level, Phase phase)
        {
            try
            {
                ElementSet elements = m_commandData.Application.ActiveUIDocument.Document.Create.NewSpaces(level, phase, this.m_commandData.Application.ActiveUIDocument.Document.ActiveView);
