...
namespace Revit.SDK.Samples.Truss.CS
{
    ...
    class TrussGeometry
    {
            ...
            try
            {
                ...
                while (iter.MoveNext())
                {
                    ...
                    Autodesk.Revit.DB.Element elem =
                        m_commandData.Application.ActiveUIDocument.Document.get_Element(id);
                    ...
                    xyzArray.Add(line.get_EndPoint(0));
                    xyzArray.Add(line.get_EndPoint(1));
                }
            }
        ...
        public FamilyInstance GetSelectedBeam(ExternalCommandData commandData)
        {
            ...
            return (FamilyInstance)commandData.Application.ActiveUIDocument.Document.get_Element(id);
        }
