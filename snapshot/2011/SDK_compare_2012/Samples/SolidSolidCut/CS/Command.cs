...
namespace Revit.SDK.Samples.SolidSolidCut.CS
{
    ...
    public class Cut : IExternalCommand
    {
            ...
            ref string message, Autodesk.Revit.DB.ElementSet elements)
        {
            ...
            CutFailureReason reason; // added by jeremy

            //Due to the API SolidSolidCutUtils.CanTwoElemsHaveSolidSolidCut() will not
            //check whether each of the two input elements can do the solid-solid cut,
            //and do not check whether the two elements are equal, so we need to check
            //them by other code to get the correct result, such as below code.
            if (solidToBeCut != cuttingSolid &&
                ...
                //SolidSolidCutUtils.CanTwoElemsHaveSolidSolidCut( solidToBeCut, cuttingSolid ) ) // jeremy: Error	1	'Autodesk.Revit.DB.SolidSolidCutUtils' does not contain a definition for 'CanTwoElemsHaveSolidSolidCut'	C:\a\lib\revit\2011\SDK\Samples\SolidSolidCut\CS\Command.cs	96	36	SolidSolidCut
                SolidSolidCutUtils.CanElementCutElement( solidToBeCut, cuttingSolid, out reason ) ) // jeremy: Error	1	'Autodesk.Revit.DB.SolidSolidCutUtils' does not contain a definition for 'CanTwoElemsHaveSolidSolidCut'	C:\a\lib\revit\2011\SDK\Samples\SolidSolidCut\CS\Command.cs	96	36	SolidSolidCut
            {
