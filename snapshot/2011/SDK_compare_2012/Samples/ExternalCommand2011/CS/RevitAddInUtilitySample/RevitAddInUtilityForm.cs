...
namespace Revit.SDK.Samples.RevitAddInUtilitySample.CS
{
   ...
   public partial class RevitAddInUtilitySampleForm : Form
   {
      ...
      private void CreateAddInManifestButton_Click(object sender, EventArgs e)
      {
         ...
         FileInfo fileInfo = new FileInfo("..\\ExternalComandRegistration\\ExternalComandRegistration.dll");

         //create an external application
         RevitAddInApplication application1 = new RevitAddInApplication(
            "ExternalApplication", fileInfo.FullName, Guid.NewGuid(), 
            "Revit.SDK.Samples.ExternalComandRegistration.CS.ExternalApplicationClass");
         ...
         RevitAddInCommand command1 = new RevitAddInCommand(
            ...
            "Revit.SDK.Samples.ExternalComandRegistration.CS.ExternalCommandCreateWall");
         command1.Description = "A simple external command which is used to create a wall.";
         command1.Text = "@createWallText";
         command1.AvailabilityClassName = "Revit.SDK.Samples.ExternalComandRegistration.CS.WallSelection";
         ...
         RevitAddInCommand command2 = new RevitAddInCommand(
            fileInfo.FullName, Guid.NewGuid(),
            "Revit.SDK.Samples.ExternalComandRegistration.CS.ExternalCommand3DView");
         command2.Description = "A simple external command which show a message box.";
         command2.Text = "@view3DText";
         command2.AvailabilityClassName = "Revit.SDK.Samples.ExternalComandRegistration.CS.View3D";
         ...
         fileInfo = new FileInfo("ExteranlCommand2011.Sample.addin");
      ...
      {
         FileInfo fileInfo = new FileInfo("ExteranlCommand2011.Sample.addin");
      ...
      /// <summary>
      /// Open new created AddIn manifest file - ExteranlCommand2011.Sample.addin
      /// </summary>
