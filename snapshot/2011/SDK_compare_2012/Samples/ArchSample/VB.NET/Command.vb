...
Public Class Command
    ...
    As Autodesk.Revit.UI.Result Implements IExternalCommand.Execute
        ...
        Try
            ...
            Do While (iter.MoveNext())
                ...
                Dim elementSet As Autodesk.Revit.DB.ElementSet = iter.Current
    ...
    Function GetValuesOfNamedProperties(ByVal application As Autodesk.Revit.ApplicationServices.Application, _
        ByVal element As Autodesk.Revit.DB.Element, ByVal propertyNames As Autodesk.Revit.Collections.Set) _
            ...
            If propertyNames.Contains(parameter.Definition.Name) Then
                ...
                Select Case parameter.StorageType
                    ...
                    Case Autodesk.Revit.DB.StorageType.ElementId
                        Dim paramElement As Autodesk.Revit.DB.Element = element.Document.Element(parameter.AsElementId)
    ...
    Function GetCommonPropertyNames(ByVal application As Autodesk.Revit.ApplicationServices.Application, _
        ByVal elementSet As Autodesk.Revit.DB.ElementSet) As Autodesk.Revit.Collections.Set
    ...
    Function GetSortedNonSymbolElements(ByVal application As Autodesk.Revit.UI.UIApplication, _
        ByVal document As Autodesk.Revit.DB.Document) As Autodesk.Revit.Collections.Map

        GetSortedNonSymbolElements = application.Application.Create.NewMap()
