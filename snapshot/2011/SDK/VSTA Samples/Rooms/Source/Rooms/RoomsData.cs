...
namespace Rooms
{
    ...
    public class RoomsData
    {
        ...
        public RoomsData(ThisApplication application)
        {
            ...
            roomCollector = roomCollector.WherePasses(roomFilter);

            foreach (Autodesk.Revit.DB.Element ee in roomCollector.ToElements())
            {
            ...
            roomTagcollector = roomTagcollector.WherePasses(roomTagFilter);

            foreach (Autodesk.Revit.DB.Element ee in roomTagcollector.ToElements())
            {
                // find the room tags
