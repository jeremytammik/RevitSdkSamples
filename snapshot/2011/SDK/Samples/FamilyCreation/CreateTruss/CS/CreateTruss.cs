    ...
    public class Command : IExternalCommand
    {
        ...
        private void MakeNewTruss()
        {
            ...
            if (null != bottomChord)
            {
                ...
                // Lock the bottom chord to bottom reference plane
            ...
            if (null != rightWeb)
            {
                ...
                // Lock the right web chord to right reference plane
            ...
            if (null != topChord)
            {
                ...
                // Lock the start point of top chord to the Intersection of left and bottom reference plane
                ...
                // Lock the end point of top chord to the Intersection of right and top reference plane
