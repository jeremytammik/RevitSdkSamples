...
Public Class Command
    ...
    Public Function SetLayer(ByVal layerNumber As Integer) As Boolean
        ...
        If Not (m_slabLayer.Material Is Nothing) Then
            ...
            youngModuleAttribute = m_slabLayer.Material.Parameter(BuiltInParameter.PHY_MATERIAL_PARAM_YOUNG_MOD1)
            ...
            youngModuleAttribute = m_slabLayer.Material.Parameter(BuiltInParameter.PHY_MATERIAL_PARAM_YOUNG_MOD2)
            If Not (youngModuleAttribute Is Nothing) Then
            ...
            youngModuleAttribute = m_slabLayer.Material.Parameter(BuiltInParameter.PHY_MATERIAL_PARAM_YOUNG_MOD3)
            If Not (youngModuleAttribute Is Nothing) Then
