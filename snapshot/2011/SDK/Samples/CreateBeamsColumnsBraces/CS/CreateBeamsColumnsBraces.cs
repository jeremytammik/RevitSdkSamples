    ...
    public class Command : IExternalCommand
    {
        ...
        public Autodesk.Revit.UI.Result Execute(Autodesk.Revit.UI.ExternalCommandData revit, ref string message, Autodesk.Revit.DB.ElementSet elements)
      {
        ...
        private void PlaceBeam(Autodesk.Revit.DB.UV point2D1, Autodesk.Revit.DB.UV point2D2, Level baseLevel, Level topLevel, FamilySymbol beamType)
        {
            ...
            FamilyInstance beam = m_revit.ActiveUIDocument.Document.Create.NewFamilyInstance(startPoint, beamType, topLevel, structuralType);
        ...
        private void PlaceBrace(Autodesk.Revit.DB.UV point2D1, Autodesk.Revit.DB.UV point2D2, Level baseLevel, Level topLevel, FamilySymbol braceType, bool isXDirection)
        {
            ...
            FamilyInstance firstBrace = m_revit.ActiveUIDocument.Document.Create.NewFamilyInstance(startPoint, braceType, structuralType);
            LocationCurve braceCurve1 = firstBrace.Location as LocationCurve;
            if (null != braceCurve1)
            {
                Line line = m_revit.Application.Create.NewLineBound(startPoint, middlePoint);
            ...
            FamilyInstance secondBrace = m_revit.ActiveUIDocument.Document.Create.NewFamilyInstance(endPoint, braceType, baseLevel, structuralType);
            LocationCurve braceCurve2  = secondBrace.Location as LocationCurve;
            if (null != braceCurve2)
            {
                Line line = m_revit.Application.Create.NewLineBound(endPoint, middlePoint);
