...
namespace Revit.SDK.Samples.MeasureHeight.CS
{
    ...
    public class Command : IExternalCommand
    {
        ...
        private Line CalculateLineAboveFloor()
        {
            ...
            ReferenceArray references = m_doc.FindReferencesByDirection(center, rayDirection, m_view3D);
            ...
            foreach (Reference reference in references)
            {
                ...
                if (reference.ElementReferenceType == ElementReferenceType.REFERENCE_TYPE_SURFACE &&
                    reference.Element.Id.IntegerValue == m_floor.Id.IntegerValue)
                {
                    // Keep the closest matching reference (using the proximity parameter to determine closeness).
                    double proximity = reference.ProximityParameter;
            ...
            Line result = m_app.Create.NewLineBound(center, intersection);
            return result;
        }
        #endregion
    }
