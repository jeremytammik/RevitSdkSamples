    ...
    public class CrtlApplication : IExternalApplication
    {
        ...
        public static EventsReactor EventReactor
        {
            get 
            {
                ...
                {
                    throw new ArgumentException("External application was not loaded yet, please make sure [ExternalApplication] section of this sample exists in your Revit.ini and it's set with correct full path of dll.", "EventReactor");
                }
                else
                {
