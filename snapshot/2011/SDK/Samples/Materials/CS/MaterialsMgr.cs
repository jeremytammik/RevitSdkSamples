...
namespace Revit.SDK.Samples.Materials.CS
{
    ...
    public class MaterialsMgr
    {
        ...
        public string DisplayUnitSystem
        {
            get
            {
                return m_document.Document.DisplayUnitSystem.ToString();
            }
        }
        ...
        public MaterialsMgr(UIDocument doc, Autodesk.Revit.UI.UIApplication app)
        {
            Debug.Assert(null != doc);
            Debug.Assert(null != app);

            m_document = doc;
            m_materials = app.Application.Create.NewMaterialSet();
        ...
        public bool GetAllMaterials()
        {
            ...
            m_materials = m_document.Document.Settings.Materials;
        ...
        public bool DuplicateNewMaterial(string materialName)
        {
            ...
            Settings settings = m_document.Document.Settings;
