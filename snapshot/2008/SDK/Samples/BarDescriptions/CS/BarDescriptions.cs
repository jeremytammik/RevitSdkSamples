...
namespace Revit.SDK.Samples.BarDescriptions.CS
{
    ...
    public class Command: IExternalCommand
    {
                                               ...
                                               ElementSet elements)
        {
            ...
            {
                message = "Can not found AreaReinforcement in Project";
        ...
        public void ExportAllData(string saveFileName)
        {
            ...
            // set table title
            string projectTitle = m_revit.Application.ActiveDocument.Title;
        ...
        {
            // reset the Cloumns of data table m_barDescriptions
            SetDataTableCloumn();

            AreaReinforcement tempAreaReinforcement = null;
            ElementIterator i = m_revit.Application.ActiveDocument.Elements;
            while (i.MoveNext())
            {
                if (!(i.Current is AreaReinforcement))
                {
                    continue;
                }
                ...
                m_areaReinforcementIdList.Add(tempAreaReinforcement.Id.Value);
        ...
        {
            int areaReinforcementId = areaReinforcement.Id.Value;
        ...
        /// <summary>
        /// edit the Cloumns of data table m_barDescriptions
        /// </summary>
