...
namespace Revit.SDK.Samples.SpotDimension.CS
{
    ...
    {
        Application m_revit;  // Store the reference of the application in Revit
        List<string>          m_views         = new List<string>();
        List<SpotDimension> m_spotDimensions = new List<SpotDimension>(); //a list to store all SpotDimensions in the project

        /// <summary>
        /// a list of all the SpotDimensions in the project
        /// </summary>
        public ReadOnlyCollection<SpotDimension> SpotDimensions
        {
            get
            {
                return new ReadOnlyCollection<SpotDimension>(m_spotDimensions);
            }
        }
