...
namespace Revit.SDK.Samples.FrameBuilder.CS
{
	...
	public partial class CreateFrameForm : Form
	{
		...
		private void CreateFramingForm_Load(object sender, EventArgs e)
		{
			...
			suspendUpdatingcheckBox.Checked = m_frameData.IsSuspendUpdating;
		...
		private void floorNumberTextBox_Validating(object sender, CancelEventArgs e)
		{
			...
			if (m_frameData.FloorNumber > m_frameData.Levels.Count)
			{
		...
		private void originXtextBox_Validating(object sender, CancelEventArgs e)
		{
			try
			{
				...
				UV oldValue = m_frameData.FrameOrigin;
		...
		/// <param name="sender"></param>
		/// <param name="e"></param>
		private void suspendUpdatingcheckBox_CheckedChanged(object sender, EventArgs e)
		{
			m_frameData.IsSuspendUpdating = suspendUpdatingcheckBox.Checked;
		}
	}
}