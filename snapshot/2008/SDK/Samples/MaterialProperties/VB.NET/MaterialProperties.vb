...
Public Class MaterialProperties
    ...
    ReadOnly Property CurrentType() As MaterialType
        Get
            Dim materialId As Integer = m_currentMaterial.AsElementId().Value
    ...
    ByVal substanceKind As MaterialType) As DataTable
        ...
        If TypeOf o Is Autodesk.Revit.Elements.Material Then
            ...
            temporaryValue = _
            (temporaryAttribute.AsDouble() * ToMetricStress).ToString(formatter) + " kgf/m2"
            ...
            temporaryValue = _
            (temporaryAttribute.AsDouble() * ToMetricUnitWeight).ToString(formatter) + " kN/m3"
            AddDataRow(temporaryAttribute.Definition.Name, temporaryValue, parameterTable)
    ...
    Private Function GetCurrentMaterial() As Autodesk.Revit.Elements.Material
        ...
        Dim identityValue As Integer = m_currentMaterial.AsElementId().Value
