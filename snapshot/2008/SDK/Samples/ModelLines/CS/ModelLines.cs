    ...
    public class ModelLines
    {
        ...
        public ReadOnlyCollection<IdInfo> EllispeIDArray
        {
            get
            {
                ...
                {
                    IdInfo info = new IdInfo("ModelEllipse", ellipse.Id.Value);
                    idArray.Add(info);
                }
        ...
        public ReadOnlyCollection<IdInfo> HermiteSplineIDArray
        {
            get
            {
                ...
                {
                    IdInfo info = new IdInfo("ModelHermiteSpline", hermite.Id.Value);
                    idArray.Add(info);
                }
                // return a read only list
                return new ReadOnlyCollection<IdInfo>(idArray);
        ...
        public ReadOnlyCollection<IdInfo> NurbSplineIDArray
        {
            get
            {
                ...
                {
                    IdInfo info = new IdInfo("ModelNurbSpline", nurb.Id.Value);
                    idArray.Add(info);
                }
                // return a read only list
                return new ReadOnlyCollection<IdInfo>(idArray);
        ...
        public ReadOnlyCollection<IdInfo> SketchPlaneIDArray
        {
            get
            {
                ...
                {
                    IdInfo info = new IdInfo("SketchPlane", sketch.Id.Value);
                    idArray.Add(info);
                }
                // return a read only list
                return new ReadOnlyCollection<IdInfo>(idArray);
        ...
        public void CreateLine(int sketchId, XYZ startPoint, XYZ endPoint)
        {
            try
            {
                ...
                // Odditional check: start point should not equal end point
        ...
        public void CreateArc(int sketchId, XYZ startPoint, XYZ endPoint, XYZ thirdPoint)
        {
            try
            {
                // First get the sketch plane by the giving element id.
                ...
                // Odditional check: the start, end and third point should not be the same
        ...
        public void CreateOthers(int sketchId, int elementId, XYZ offsetPoint)
        {
            // First get the sketch plane by the giving element id.
            SketchPlane workPlane = GetSketchPlaneById(sketchId);
            ...
            // Get the ElementId which used to get the corresponding element
            ...
            {
                m_revit.ActiveDocument.Move(m, ref offsetPoint);    // move the lines
            }
        ...
        void GetModelLines()
        {
            ...
            while (iter.MoveNext())
            {
                ...
                // So I get every model line in current.
        ...
        void GetSketchPlane()
        {
            ...
            while (iter.MoveNext())
            {
                // If the element is not a SketchPlane, just continue
                SketchPlane sketch = iter.Current as SketchPlane;
                if (null == sketch)
                {
                    continue;
                }
        ...
        /// <summary>
        /// Refresh the m_informationMap memeber, inlude the number of each model line type
        /// </summary>
        ...
        /// <summary>
        /// Use ElementId to get the corresponding element
        /// </summary>
        /// <param name="id">the element id value</param>
        /// <returns>the corresponding element</returns>
        Autodesk.Revit.Element GetElementById(int id)
        {
            // Create a ElementId data
            ElementId elementId = new ElementId();
            elementId.Value = id;

            // Get the corresponding element
            return m_revit.ActiveDocument.get_Element(ref elementId);
        }


        /// <summary>
        /// Use ElementId to get the corresponding sketch plane
        /// </summary>
        /// <param name="id">the element id value</param>
