...
{
    /// <summary>
    /// Data class which stores lower priority information for export
    /// </summary>
    public class ExportOptionsData
    {
        ...
        List<Autodesk.Revit.Enums.PropOverrideMode> m_enumLayersAndProperties;
        ...
        Autodesk.Revit.Enums.PropOverrideMode m_exportLayersAndProperties;

        // List of Autodesk.Revit.Enums.LineScaling defined in Revit
        List<Autodesk.Revit.Enums.LineScaling> m_enumLineScaling;

        // Line scaling option to export
        Autodesk.Revit.Enums.LineScaling m_exportLineScaling;
        ...
        List<Autodesk.Revit.Enums.ExportUnit> m_enumUnits;

        // Export unit option to export
        Autodesk.Revit.Enums.ExportUnit m_exportUnit;

        //String list of solid used in UI
        List<String> m_solids;

        // List of Autodesk.Revit.Enums.SolidGeometry defined in Revit
        List<Autodesk.Revit.Enums.SolidGeometry> m_enumSolids;

        //Solid geometry option to export
        Autodesk.Revit.Enums.SolidGeometry m_exportSolid;
        ...
        /// </summary>
        public ReadOnlyCollection<Autodesk.Revit.Enums.PropOverrideMode> EnumLayersAndProperties
        {
            get 
            { 
                return new ReadOnlyCollection<Autodesk.Revit.Enums.PropOverrideMode>(m_enumLayersAndProperties); 
            }
        } 
        ...
        /// PropOverrideMode Option to export
        /// </summary>
        public Autodesk.Revit.Enums.PropOverrideMode ExportLayersAndProperties
        {
            get 
            { 
        ...
        /// </summary>
        public ReadOnlyCollection<Autodesk.Revit.Enums.LineScaling> EnumLineScaling
        {
            get 
            { 
                return new ReadOnlyCollection<Autodesk.Revit.Enums.LineScaling>(m_enumLineScaling); 
            }
        }      
        ...
        /// Line scaling option to export
        /// </summary>
        public Autodesk.Revit.Enums.LineScaling ExportLineScaling
        {
            get 
            { 
        ...
        /// </summary>
        public ReadOnlyCollection<Autodesk.Revit.Enums.ExportUnit> EnumUnits
        {
            get 
            { 
                return new ReadOnlyCollection<Autodesk.Revit.Enums.ExportUnit>(m_enumUnits); 
            }
        }  
        ...
        /// Export unit option to export
        /// </summary>
        public Autodesk.Revit.Enums.ExportUnit ExportUnit
        {
            get 
            { 
                return m_exportUnit; 
        ...
        /// </summary>
        public ReadOnlyCollection<Autodesk.Revit.Enums.SolidGeometry> EnumSolids
        {
            get 
            { 
                return new ReadOnlyCollection<Autodesk.Revit.Enums.SolidGeometry>(m_enumSolids);
            }
        }
        ...
        /// </summary>
        public Autodesk.Revit.Enums.SolidGeometry ExportSolid
        {
            get 
            {
        ...
        /// Constructor
        /// </summary>
        public ExportOptionsData(ExternalCommandData commandData)
        {
            Initialize();
        }
        ...
        void Initialize()
        {
            ...
            m_enumLayersAndProperties = new List<Autodesk.Revit.Enums.PropOverrideMode>();
            ...
            m_enumLineScaling = new List<Autodesk.Revit.Enums.LineScaling>();
            ...
            m_enumUnits = new List<Autodesk.Revit.Enums.ExportUnit>();
            ...
            m_enumSolids = new List<Autodesk.Revit.Enums.SolidGeometry>();
