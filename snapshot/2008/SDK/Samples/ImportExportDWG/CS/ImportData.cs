...
{
    /// <summary>
    /// Data class which stores the information for import
    /// </summary>
    public class ImportData
    {
        ...
        /// <summary>
        /// Get or set the import file name
        /// </summary>
        ...
        public ImportData(ExternalCommandData commandData)
        {
        ...
        public bool Import()
        {
            ...
            bool imported = doc.Import(m_importFileName, dwgImportOption, ref element);
            return imported;
        }
        #endregion
        ...
        private void Initialize()
        {
            ...
            m_enumColorMode.Add(Autodesk.Revit.Enums.ImportColorMode.BlackAndWhige);
            ...
            //Whether active view is 3D
            m_is3DView = false;
            if (m_commandData.Application.ActiveDocument.ActiveView.ViewType == 
                Autodesk.Revit.Enums.ViewType.ThreeD)
            {
                m_is3DView = true;
            }            
