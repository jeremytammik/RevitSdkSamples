    ...
    public class Command : IExternalCommand
    {
            ...
            ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            try
            {
                ...
                Definition visibleParamDef = apiGroup.Definitions.Create("VisibleParam",
                                                                         ParameterType.Text, true);
                //Create a invisible "InvisibleParam" of text type.
                Definition invisibleParamDef = apiGroup.Definitions.Create("InvisibleParam",
                                                                        ParameterType.Text, false);
                //get walls category
                Category wallCat = revitApp.ActiveDocument.Settings.Categories.get_Item("Walls");
                ...
                revitApp.ActiveDocument.ParameterBindings.Insert(visibleParamDef, binding);
                revitApp.ActiveDocument.ParameterBindings.Insert(invisibleParamDef, binding);
