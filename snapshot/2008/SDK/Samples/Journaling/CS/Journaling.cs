...
namespace Revit.SDK.Samples.Journaling.CS
{
    public class Journaling
    {
        ...
        public Journaling(ExternalCommandData commandData)
        {
            ...
            m_canReadData = (0 < commandData.Data.Size) ? true : false;
        ...
        private void ReadJournalData()
        {
            ...
            StringStringMap dataMap = m_commandData.Data;
            ...
            ElementId id = new ElementId();     // get the level by its id
            try
            {
                id.Value = Convert.ToInt32(dataValue);  // translate the string to int
            }
            catch (Exception)
            {
                throw new InvalidDataException("The level information in journal is incorrect");
            }
            m_createlevel = doc.get_Element(ref id) as Level;
        ...
        private void CreateWall()
        {
            ...
            Creation.Application createApp = m_commandData.Application.Create;
            Creation.Document createDoc = m_commandData.Application.ActiveDocument.Create;
            
            // Create geometry line(curve)
            Line geometryLine = createApp.NewLine(ref m_startPoint, ref m_endPoint, true);
            ...
            Wall createdWall = createDoc.NewWall(geometryLine, m_createType, m_createlevel,
        ...
        private void WriteJournalData()
        {
            ...
            dataMap.Insert("Level Id", m_createlevel.Id.Value.ToString());  // add level id
        ...
        /// <summary>
        /// The helper fuction which convert a format string to a XYZ point
        /// </summary>
        /// <param name="pointString">a format string</param>
        /// <returns>the converted XYZ point</returns>
        private static XYZ StirngToXYZ(String pointString)
        {
            ...
            // Return a XYZ point using the collected data
            try
            {
        ...
        /// <summary>
        /// The helper fuction which convert a XYZ point to a format string
        /// </summary>
        /// <param name="point">A XYZ point</param>
