...
''' <summary>
''' external command class for Revit, demo how get implement the IExternalCommand interface
''' </summary>
...
''' <summary>
''' external command class for Revit to pop up a form 
''' </summary>
Public Class CommandForm
    ...
    Public Function Execute(ByVal commandData As Autodesk.Revit.ExternalCommandData, _
        ...
        Try
            Dim myForm As HelloRevitForm = New HelloRevitForm()
            myForm.ShowDialog()
