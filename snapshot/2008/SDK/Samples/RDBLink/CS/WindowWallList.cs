...
namespace Revit.SDK.Samples.RDBLink.CS
{
    ...
    public class WindowWallList : NonCreatableElementList
    {
        ...
        /// </summary>
        public WindowWallList()
            : base()
        {
            TableName = "WindowWall";
        } 
        #endregion
        ...
        protected override bool CanAppend(Element element)
        {
            ...
            if (GetCategoryId(fi) == BuiltInCategory.OST_Windows)
            {
        ...
        {
            FamilyInstance fi = element as FamilyInstance;
            row["WindowId"] = GetIdDbValue(element);
            row["WindowName"] = GetNameDbValue(element);
