...
namespace Revit.SDK.Samples.RDBLink.CS
{
    ...
    public class ElementPhaseList : NonCreatableElementList
    {
        ...
        /// </summary>
        public ElementPhaseList() : base() { TableName = "ElementPhase"; } 
        #endregion
        ...
        {
            if (element != null && element.Id.Value != -1 && element.PhaseCreated != null)
                return true;
            return false;
        }
        ...
        protected override void PopulateDbRow(Element element, DataRow row)
        {
            ...
            row["PhaseCreatedId"] = GetIdDbValue(element.PhaseCreated);
            row["PhaseName"] = GetNameDbValue(element.PhaseCreated);
        } 
        #endregion
    }
}
