...
namespace Revit.SDK.Samples.StructSample.CS
{
    ...
    public class Command : IExternalCommand
    {
            ...
            double spacing, Autodesk.Revit.Symbols.FamilySymbol columnType)
        {
            ...
            double angle = wallVec.Angle(ref axis);
            ...
            double angle, FamilySymbol columnType, ElementId baseLevelId, ElementId topLevelId)
        {
            ...
            Autodesk.Revit.Elements.FamilyInstance column = rvtDoc.Create.NewFamilyInstance(ref point, columnType,
            ...
            Autodesk.Revit.Geometry.Line axis = rvtApp.Create.NewLineUnbound(ref point, ref zVec);
