...
namespace Revit.SDK.Samples.ObjectViewer.CS
{
	...
	public static class MathUtil
	{
		...
		/// <summary>
        /// subtract two XYZ as Matrix
		/// </summary>
		/// <param name="lhs"></param>
		/// <param name="rhs"></param>
		/// <returns></returns>
		public static XYZ SubXYZ(XYZ lhs, XYZ rhs)
		{
        ...
        /// <summary>
        /// Add two XYZ as Matrix
        /// </summary>
        /// <param name="lhs"></param>
        /// <param name="rhs"></param>
        /// <returns></returns>
        public static XYZ AddXYZ(XYZ lhs, XYZ rhs)
		{
			double x = lhs.X + rhs.X;
			double y = lhs.Y + rhs.Y;
			double z = lhs.Z + rhs.Z;
		...
		/// <summary>
		/// divide a XYZ by a number
		/// </summary>
		/// <param name="lhs">divided XYZ</param>
		/// <param name="rhs">number</param>
		/// <returns>result</returns>
		public static XYZ DivideXYZ(XYZ lhs, double rhs)
		{
		...
		/// <returns></returns>
		public static XYZ GetBasis(XYZ point, Transform transform)
		{
			double x = point.X;
			double y = point.Y;
			double z = point.Z;
		...
		/// <summary>
		/// transform a Vector instance to a XYZ instance
		/// </summary>
		/// <param name="v">transformed Vector</param>
		/// <returns>result XYZ</returns>
		public static XYZ Vector2XYZ(Vector v)
		{
			return new XYZ(v.X, v.Y, v.Z);
		}

		/// <summary>
		/// transform a XYZ instance to a Vector instance
		/// </summary>
		/// <param name="pnt">transformed XYZ</param>
		/// <returns>result Vector</returns>
		public static Vector XYZ2Vector(XYZ pnt)
		{
