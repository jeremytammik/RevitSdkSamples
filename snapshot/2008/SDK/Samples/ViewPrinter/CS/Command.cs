...
namespace Revit.SDK.Samples.ViewPrinter.CS
{
    ...
    public class Command : IExternalCommand
    {
        ...
        ref string message, ElementSet elements)
        {
            try
            {
                PrintMgr viewPrinter = new PrintMgr(commandData);
                using (ViewPrinterForm viewPrinterDlg = new ViewPrinterForm(viewPrinter))
                {
                    if (viewPrinterDlg.ShowDialog() == DialogResult.Cancel)
                    {
