...
Public Class Command
    ...
    Public Function Execute(ByVal revit As Autodesk.Revit.ExternalCommandData, ByRef message As String, ByVal elements As ElementSet) As IExternalCommand.Result Implements Autodesk.Revit.IExternalCommand.Execute
...
nextLoop:
    ...
    Private Sub PlaceColumn(ByVal point2D As Autodesk.Revit.Geometry.UV, ByVal columnType As Autodesk.Revit.Symbols.FamilySymbol, ByVal baseLevel As Autodesk.Revit.Elements.Level, ByVal topLevel As Autodesk.Revit.Elements.Level)
        ...
        Dim point As New Autodesk.Revit.Geometry.XYZ(point2D.U, point2D.V, 0)
