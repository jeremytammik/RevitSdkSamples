    ...
    public class Command : IExternalCommand
    {
        ...
        bool initialize()
        {
            ...
            foreach (Autodesk.Revit.Element e in selections)
            {
                ...
                if (null != wall)
                {
                    if( WallType.WallKind.Basic != wall.WallType.Kind ) // jeremy
                    {
                        continue;
                    }
                    m_walls.Add(wall);
        ...
        public bool AddDimension()
        {
            ...
            for (int i = 0; i < m_walls.Count; i++)
            {
                ...
                Line newLine = m_revit.Application.Create.NewLine(ref locationStartPoint,
                                                                  ref locationEndPoint,
                                                                  true);
                ...
                for( int j = 0; j < geoObjectArray.Size; ++j )
                {
                    ...
                    if (null != curve)
                    {
                        ...
                        if (Validate(newLine, curve as Line))
                        {
        ...
        bool Validate(Line line1, Line line2)
        {
