...
Public Class RoomViewer
  ...
  Dim mViewer As RevitViewer.Wireframe
    ...
    Private Sub DrawCurve(ByVal curve As Autodesk.Revit.Geometry.Curve)
        Dim q As Autodesk.Revit.Geometry.XYZ = curve.EndPoint(0)
        Dim p As Autodesk.Revit.Geometry.XYZ = curve.EndPoint(1)
        mViewer.Add(q.X, q.Y, q.Z, p.X, p.Y, p.Z)
        '
        ' added by jeremy to display arced wall:
        '
