...
namespace Revit.SDK.Samples.CreateComplexAreaRein.CS
{
	...
	public class AreaReinData
	{
		...
		public AreaReinData()
		{
			m_areaReinTypes = new List<AreaReinforcementType>();
		}

		private List<AreaReinforcementType> m_areaReinTypes;
		private LayoutRules m_layoutRule = LayoutRules.Maximum_Spacing;
		private object m_areaReinType;

		/// <summary>
		/// all the AreaReinforcementTypes in the current project
		/// </summary>
		public List<AreaReinforcementType> AreaReinTypes
		{
			get
			{
				return m_areaReinTypes;
			}
			set
			{
				m_areaReinTypes = value;
			}
		}

		/// <summary>
		/// user selected AreaReinforcementType when create
		/// </summary>
		public object AreaReinType
		{
			get
			{
				return m_areaReinType;
			}
			set
			{
				m_areaReinType = value;
			}
		}
