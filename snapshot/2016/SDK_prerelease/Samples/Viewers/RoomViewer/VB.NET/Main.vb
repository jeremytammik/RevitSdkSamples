...
Public Class RoomViewer
    ...
    'Dim boundaries As IList(Of IList(Of Autodesk.Revit.DB.Architecture.BoundarySegment)) ' jeremy
    Dim boundaries As IList(Of IList(Of Autodesk.Revit.DB.BoundarySegment)) ' jeremy
        ...
        If boundaries Is Nothing Then
            ...
            Return
        End If
    'Dim boundary As IList(Of Autodesk.Revit.DB.Architecture.BoundarySegment) ' jeremy
    Dim boundary As IList(Of Autodesk.Revit.DB.BoundarySegment) ' jeremy
        For Each boundary In boundaries
      'Dim segment As Autodesk.Revit.DB.Architecture.BoundarySegment ' jeremy
      Dim segment As Autodesk.Revit.DB.BoundarySegment ' jeremy
